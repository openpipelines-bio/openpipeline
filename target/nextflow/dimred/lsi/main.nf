// lsi qc-workflow-with-quantile-filtering_build
// 
...
meta = [
  ...
  "build_info" : {
    "config" : "/home/runner/work/openpipeline/openpipeline/src/dimred/lsi/config.vsh.yaml",
    "runner" : "nextflow",
    "engine" : "docker",
...
par = {
  ...
  'scale_embeddings': $( if [ ! -z ${VIASH_PAR_SCALE_EMBEDDINGS+x} ]; then echo "r'${VIASH_PAR_SCALE_EMBEDDINGS//\\'/\\'\\"\\'\\"r\\'}'.lower() == 'true'"; else echo None; fi ),
...
meta["defaults"] = [
  ...
  "container" : {
    "registry" : "ghcr.io",
    "image" : "openpipelines-bio/openpipeline/dimred/lsi",
