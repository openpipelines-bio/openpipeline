...
thisHelpMessage = '''pca main_build

Computes PCA coordinates, loadings and variance decomposition. Uses the
implementation of scikit-learn [Pedregosa11].
...
Options:
    ...
    --output_key
        type: string
        default: pca
        The pre/postfix under which to store the PCA results. More specifically,
.obsm["X_"+key], .uns[key] and .varm["loadings_"+key].
