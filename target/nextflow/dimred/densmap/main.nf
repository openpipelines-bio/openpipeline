      ...
      },
      {
        ...
        "arguments" : [
          ...
          },
          {
            "type" : "double",
            "name" : "--spread",
            "description" : "The effective scale of embedded points. In combination with `min_dist` this \ndetermines how clustered/clumped the embedded points are.\n",
            "default" : [
              1.0
            ],
            "required" : false,
    ...
    "resources" : [
      {
        ...
        "path" : "script.py",
        "is_executable" : true,
        "parent" : "file:/home/runner/work/openpipeline/openpipeline/src/dimred/densmap/"
      },
      {
        "type" : "file",
...
par = {
  ...
  'lambda': $( if [ ! -z ${VIASH_PAR_LAMBDA+x} ]; then echo "float(r'${VIASH_PAR_LAMBDA//\\'/\\'\\"\\'\\"r\\'}')"; else echo None; fi ),
  'fraction': $( if [ ! -z ${VIASH_PAR_FRACTION+x} ]; then echo "float(r'${VIASH_PAR_FRACTION//\\'/\\'\\"\\'\\"r\\'}')"; else echo None; fi ),
  'var_shift': $( if [ ! -z ${VIASH_PAR_VAR_SHIFT+x} ]; then echo "float(r'${VIASH_PAR_VAR_SHIFT//\\'/\\'\\"\\'\\"r\\'}')"; else echo None; fi )
}
meta = {
...
meta["defaults"] = [
  ...
  "container" : {
    "registry" : "ghcr.io",
    "image" : "openpipelines-bio/dimred/densmap",
