// cellbender_remove_background_v0_2 add-lognormalization-to-celltypist_build
// 
...
meta["defaults"] = [
  ...
  "container" : {
    "registry" : "ghcr.io",
    "image" : "openpipelines-bio/openpipeline/correction/cellbender_remove_background_v0_2",
