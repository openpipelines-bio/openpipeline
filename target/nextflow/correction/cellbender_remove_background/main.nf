...
thisConfig = processConfig(jsonSlurper.parseText('''{
    ...
    "resources" : [
      {
        ...
        "path" : "script.py",
        "is_executable" : true,
        "parent" : "file:/home/di/code/openpipeline/src/correction/cellbender_remove_background/config.vsh.yaml"
      },
      {
        "type" : "file",
        "path" : "helper.py",
  ...
  "info" : {
    "config" : "/home/di/code/openpipeline/src/correction/cellbender_remove_background/config.vsh.yaml",
    "platform" : "nextflow",
    "viash_version" : "0.7.1",
