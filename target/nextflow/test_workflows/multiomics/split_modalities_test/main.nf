// split_modalities_test integration_build
// 
...
meta = [
    ...
    "resources" : [
      {
        ...
        "path" : "script.py",
        "is_executable" : true,
        "parent" : "file:/home/runner/work/openpipeline/openpipeline/src/workflows/test_workflows/multiomics/split_modalities/"
      },
      {
        "type" : "file",
  ...
  "info" : {
    "config" : "/home/runner/work/openpipeline/openpipeline/src/workflows/test_workflows/multiomics/split_modalities/config.vsh.yaml",
    "platform" : "nextflow",
    "output" : "/home/runner/work/openpipeline/openpipeline/target/nextflow/test_workflows/multiomics/split_modalities_test",
    "viash_version" : "0.8.6",
...
par = {
  ...
  'mod_dir': $( if [ ! -z ${VIASH_PAR_MOD_DIR+x} ]; then echo "r'${VIASH_PAR_MOD_DIR//\\'/\\'\\"\\'\\"r\\'}'"; else echo None; fi ),
...
meta["defaults"] = [
  ...
  "container" : {
    "registry" : "ghcr.io",
    "image" : "openpipelines-bio/test_workflows/multiomics/split_modalities_test",
