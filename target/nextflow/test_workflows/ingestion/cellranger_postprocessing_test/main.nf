// cellranger_postprocessing_test integration_build
// 
...
meta = [
  ...
  "build_info" : {
    "config" : "/home/runner/work/openpipeline/openpipeline/src/workflows/test_workflows/ingestion/cellranger_postprocessing/config.vsh.yaml",
    "runner" : "nextflow",
    "engine" : "docker",
    "output" : "/home/runner/work/openpipeline/openpipeline/target/nextflow/test_workflows/ingestion/cellranger_postprocessing_test",
...
par = {
  ...
  'input_og': $( if [ ! -z ${VIASH_PAR_INPUT_OG+x} ]; then echo "r'${VIASH_PAR_INPUT_OG//\\'/\\'\\"\\'\\"r\\'}'"; else echo None; fi ),
  'is_corrected': $( if [ ! -z ${VIASH_PAR_IS_CORRECTED+x} ]; then echo "r'${VIASH_PAR_IS_CORRECTED//\\'/\\'\\"\\'\\"r\\'}'.lower() == 'true'"; else echo None; fi )
}
meta = {
...
meta["defaults"] = [
  ...
  "container" : {
    "registry" : "ghcr.io",
    "image" : "openpipelines-bio/test_workflows/ingestion/cellranger_postprocessing_test",
