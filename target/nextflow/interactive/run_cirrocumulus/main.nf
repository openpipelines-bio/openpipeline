// run_cirrocumulus integration_build
// 
...
meta = [
  ...
  "build_info" : {
    "config" : "/home/runner/work/openpipeline/openpipeline/src/interactive/run_cirrocumulus/config.vsh.yaml",
    "runner" : "nextflow",
    "engine" : "docker",
    "output" : "/home/runner/work/openpipeline/openpipeline/target/nextflow/interactive/run_cirrocumulus",
...
$( if [ ! -z ${VIASH_PAR_PORT+x} ]; then echo "${VIASH_PAR_PORT}" | sed "s#'#'\\"'\\"'#g;s#.*#par_port='&'#" ; else echo "# par_port="; fi )
...
meta["defaults"] = [
  ...
  "container" : {
    "registry" : "ghcr.io",
    "image" : "openpipelines-bio/interactive/run_cirrocumulus",
