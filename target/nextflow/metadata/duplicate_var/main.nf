// duplicate_var harmony-knn-annoation-workflow_build
// 
...
meta = [
  ...
  "description" : "Make a copy of an existing .var field or index to another .var field within the same mudata object.\n",
  "test_resources" : [
    {
      "type" : "python_script",
      "path" : "test.py",
  ...
  "build_info" : {
    "config" : "/home/runner/work/openpipeline/openpipeline/src/metadata/duplicate_var/config.vsh.yaml",
    "runner" : "nextflow",
    "engine" : "docker",
...
meta["defaults"] = [
  ...
  "container" : {
    "registry" : "ghcr.io",
    "image" : "openpipelines-bio/openpipeline/metadata/duplicate_var",
