...
thisConfig = processConfig(jsonSlurper.parseText('''{
    ...
    "resources" : [
      {
        ...
        "path" : "script.py",
        "is_executable" : true,
        "parent" : "file:/home/di/code/openpipeline/src/metadata/join_uns_to_obs/config.vsh.yml"
      }
    ],
  ...
  "info" : {
    "config" : "/home/di/code/openpipeline/src/metadata/join_uns_to_obs/config.vsh.yml",
    "platform" : "nextflow",
    "viash_version" : "0.7.1",
