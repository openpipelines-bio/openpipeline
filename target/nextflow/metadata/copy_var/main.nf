...
meta = [
  ...
  "argument_groups" : [
    {
      ...
      "arguments" : [
        ...
        },
        {
          "type" : "string",
          "name" : "--input_var_key",
          "description" : ".var column to be copied. If no key is provided, the .var index will be copied.",
          "required" : false,
          "direction" : "input",
          "multiple" : false,
          "multiple_sep" : ";"
    ...
    },
    {
      ...
      "arguments" : [
        ...
        },
        {
          "type" : "string",
          "name" : "--output_var_key",
          "description" : ".var column where the copied --input_var_key will be stored.",
          "required" : true,
          "direction" : "input",
          "multiple" : false,
          "multiple_sep" : ";"
  ...
  "description" : "Make a copy of an existing .var column to another .var column.\n",
  "test_resources" : [
    {
      "type" : "python_script",
      "path" : "test.py",
  ...
  "build_info" : {
    "config" : "/home/runner/work/openpipeline/openpipeline/src/metadata/copy_var/config.vsh.yaml",
    "runner" : "nextflow",
    "engine" : "docker",
    "output" : "/home/runner/work/openpipeline/openpipeline/target/nextflow/metadata/copy_var",
...
meta["defaults"] = [
  ...
  "container" : {
    "registry" : "ghcr.io",
    "image" : "openpipelines-bio/openpipeline/metadata/copy_var",
    "tag" : "scgpt-knn_build"
  },
  "label" : [
    "singlecpu",
