// rename_var annotation-workflow_build
// 
...
meta = [
  ...
  "functionality" : {
    ...
    "argument_groups" : [
      {
        ...
        "arguments" : [
          ...
          },
          {
            "type" : "string",
            "name" : "--var_key_input",
            "description" : "Key of the `.var` column to be renamed. \nIf not provided, the `.var` index will be moved to a new `.var`` column.\n",
            "required" : false,
            "direction" : "input",
            "multiple" : false,
            "multiple_sep" : ":",
      ...
      },
      {
        ...
        "arguments" : [
          ...
          },
          {
            "type" : "string",
            "name" : "--var_key_output",
            "description" : "The new name of the `.var` column.\n",
            "required" : true,
            "direction" : "input",
            "multiple" : false,
            "multiple_sep" : ":",
    ...
    "resources" : [
      {
        ...
        "path" : "script.py",
        "is_executable" : true,
        "parent" : "file:/home/runner/work/openpipeline/openpipeline/src/metadata/rename_var/"
      },
      {
        "type" : "file",
    ...
    "description" : "Component to rename a `.var` column.\n",
    "test_resources" : [
      {
        "type" : "python_script",
        "path" : "test.py",
  ...
  "info" : {
    "config" : "/home/runner/work/openpipeline/openpipeline/src/metadata/rename_var/config.vsh.yaml",
    "platform" : "nextflow",
    "output" : "/home/runner/work/openpipeline/openpipeline/target/nextflow/metadata/rename_var",
    "viash_version" : "0.8.6",
...
par = {
  ...
  'var_key_input': $( if [ ! -z ${VIASH_PAR_VAR_KEY_INPUT+x} ]; then echo "r'${VIASH_PAR_VAR_KEY_INPUT//\\'/\\'\\"\\'\\"r\\'}'"; else echo None; fi ),
  'output': $( if [ ! -z ${VIASH_PAR_OUTPUT+x} ]; then echo "r'${VIASH_PAR_OUTPUT//\\'/\\'\\"\\'\\"r\\'}'"; else echo None; fi ),
  'var_key_output': $( if [ ! -z ${VIASH_PAR_VAR_KEY_OUTPUT+x} ]; then echo "r'${VIASH_PAR_VAR_KEY_OUTPUT//\\'/\\'\\"\\'\\"r\\'}'"; else echo None; fi ),
...
meta["defaults"] = [
  ...
  "container" : {
    "registry" : "ghcr.io",
    "image" : "openpipelines-bio/metadata/rename_var",
