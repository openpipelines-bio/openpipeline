// copy_obs harmony-knn-annoation-workflow_build
// 
...
meta = [
  ...
  "argument_groups" : [
    {
      ...
      "arguments" : [
        ...
        },
        {
          "type" : "string",
          "name" : "--input_obs_key",
          "description" : ".obs column to be copied.",
          "required" : true,
          "direction" : "input",
          "multiple" : false,
          "multiple_sep" : ";"
  ...
  "description" : "Make a copy of an existing .obs column to another .obs column.\n",
  "test_resources" : [
    {
      "type" : "python_script",
      "path" : "test.py",
  ...
  "build_info" : {
    "config" : "/home/runner/work/openpipeline/openpipeline/src/metadata/copy_obs/config.vsh.yaml",
    "runner" : "nextflow",
    "engine" : "docker",
    "output" : "/home/runner/work/openpipeline/openpipeline/target/nextflow/metadata/copy_obs",
...
par = {
  ...
  'output_obs_key': $( if [ ! -z ${VIASH_PAR_OUTPUT_OBS_KEY+x} ]; then echo "r'${VIASH_PAR_OUTPUT_OBS_KEY//\\'/\\'\\"\\'\\"r\\'}'"; else echo None; fi ),
...
meta["defaults"] = [
  ...
  "container" : {
    "registry" : "ghcr.io",
    "image" : "openpipelines-bio/openpipeline/metadata/copy_obs",
