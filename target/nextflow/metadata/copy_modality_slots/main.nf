// copy_modality_slots integration_build
// 
...
meta = [
    ...
    },
    {
      ...
      "arguments" : [
        ...
        },
        {
          ...
          "description" : "Which modality in the source data to copy slots from. Defaults to\nthe value of --modality.\n",
          "required" : false,
          "direction" : "input",
          "multiple" : false,
          "multiple_sep" : ";"
    ...
    },
    {
      ...
      "arguments" : [
        ...
        },
        {
          "type" : "string",
          "name" : "--var",
          "description" : ".var columns to copy. If not specified, all .var columns present in\nthe source but missing from the input are copied.\n",
          "example" : [
            "var1",
            "var2"
          ],
        ...
        },
        {
          "type" : "string",
          "name" : "--layers",
          "description" : ".layers keys to copy. If not specified, all .layers keys present in\nthe source but missing from the input are copied.\n",
          "example" : [
            "layer1",
            "layer2"
          ],
        ...
        },
        {
          "type" : "string",
          "name" : "--obsm",
          "description" : ".obsm keys to copy. If not specified, all .obsm keys present in the\nsource but missing from the input are copied.\n",
          "example" : [
            "obsm1",
            "obsm2"
          ],
        ...
        },
        {
          "type" : "string",
          "name" : "--varm",
          "description" : ".varm keys to copy. If not specified, all .varm keys present in the\nsource but missing from the input are copied.\n",
          "example" : [
            "varm1",
            "varm2"
          ],
        ...
        },
        {
          "type" : "string",
          "name" : "--obsp",
          "description" : ".obsp keys to copy. If not specified, all .obsp keys present in the\nsource but missing from the input are copied.\n",
          "example" : [
            "obsp1",
            "obsp2"
          ],
        ...
        },
        {
          "type" : "string",
          "name" : "--varp",
          "description" : ".varp keys to copy. If not specified, all .varp keys present in the\nsource but missing from the input are copied.\n",
          "example" : [
            "varp1",
            "varp2"
          ],
        ...
        },
        {
          "type" : "string",
          "name" : "--uns",
          "description" : ".uns keys to copy. If not specified, all .uns keys present in the\nsource but missing from the input are copied.\n",
          "example" : [
            "uns1",
            "uns2"
          ],
  ...
  "build_info" : {
    "config" : "/home/runner/work/openpipeline/openpipeline/src/metadata/copy_modality_slots/config.vsh.yaml",
    "runner" : "nextflow",
    "engine" : "docker",
    "output" : "/home/runner/work/openpipeline/openpipeline/target/nextflow/metadata/copy_modality_slots",
    "viash_version" : "0.9.7",
...
par = {
  ...
  'source': $( if [ ! -z ${VIASH_PAR_SOURCE+x} ]; then echo "r'${VIASH_PAR_SOURCE//\\'/\\'\\"\\'\\"r\\'}'"; else echo None; fi ),
  'source_modality': $( if [ ! -z ${VIASH_PAR_SOURCE_MODALITY+x} ]; then echo "r'${VIASH_PAR_SOURCE_MODALITY//\\'/\\'\\"\\'\\"r\\'}'"; else echo None; fi ),
  'source_var_gene_names': $( if [ ! -z ${VIASH_PAR_SOURCE_VAR_GENE_NAMES+x} ]; then echo "r'${VIASH_PAR_SOURCE_VAR_GENE_NAMES//\\'/\\'\\"\\'\\"r\\'}'"; else echo None; fi ),
  'obs': $( if [ ! -z ${VIASH_PAR_OBS+x} ]; then echo "r'${VIASH_PAR_OBS//\\'/\\'\\"\\'\\"r\\'}'.split(';')"; else echo None; fi ),
  'var': $( if [ ! -z ${VIASH_PAR_VAR+x} ]; then echo "r'${VIASH_PAR_VAR//\\'/\\'\\"\\'\\"r\\'}'.split(';')"; else echo None; fi ),
  'layers': $( if [ ! -z ${VIASH_PAR_LAYERS+x} ]; then echo "r'${VIASH_PAR_LAYERS//\\'/\\'\\"\\'\\"r\\'}'.split(';')"; else echo None; fi ),
  'obsm': $( if [ ! -z ${VIASH_PAR_OBSM+x} ]; then echo "r'${VIASH_PAR_OBSM//\\'/\\'\\"\\'\\"r\\'}'.split(';')"; else echo None; fi ),
  'varm': $( if [ ! -z ${VIASH_PAR_VARM+x} ]; then echo "r'${VIASH_PAR_VARM//\\'/\\'\\"\\'\\"r\\'}'.split(';')"; else echo None; fi ),
  'obsp': $( if [ ! -z ${VIASH_PAR_OBSP+x} ]; then echo "r'${VIASH_PAR_OBSP//\\'/\\'\\"\\'\\"r\\'}'.split(';')"; else echo None; fi ),
  'varp': $( if [ ! -z ${VIASH_PAR_VARP+x} ]; then echo "r'${VIASH_PAR_VARP//\\'/\\'\\"\\'\\"r\\'}'.split(';')"; else echo None; fi ),
  'uns': $( if [ ! -z ${VIASH_PAR_UNS+x} ]; then echo "r'${VIASH_PAR_UNS//\\'/\\'\\"\\'\\"r\\'}'.split(';')"; else echo None; fi ),
  'allow_overwrite': $( if [ ! -z ${VIASH_PAR_ALLOW_OVERWRITE+x} ]; then echo "r'${VIASH_PAR_ALLOW_OVERWRITE//\\'/\\'\\"\\'\\"r\\'}'.lower() == 'true'"; else echo None; fi ),
  'allow_partial': $( if [ ! -z ${VIASH_PAR_ALLOW_PARTIAL+x} ]; then echo "r'${VIASH_PAR_ALLOW_PARTIAL//\\'/\\'\\"\\'\\"r\\'}'.lower() == 'true'"; else echo None; fi ),
...
meta["defaults"] = [
  ...
  "container" : {
    "registry" : "ghcr.io",
    "image" : "openpipelines-bio/openpipeline/metadata/copy_modality_slots",
