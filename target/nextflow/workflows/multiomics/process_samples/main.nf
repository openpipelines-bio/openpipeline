// process_samples qc-workflow-with-quantile-filtering_build
// 
...
meta = [
  ...
  "dependencies" : [
    ...
    {
      "name" : "workflows/multiomics/process_singlesample",
      "repository" : {
        "type" : "local"
      }
    },
...
include { process_singlesample } from "${meta.resources_dir}/../../../../nextflow/workflows/multiomics/process_singlesample/main.nf"
