// neighbors_leiden_umap integration_build
// 
...
include { neighbors as find_neighbors_viashalias } from "${meta.root_dir}/dependencies/vsh/vsh/openpipeline_rapids/v0.1.3/_private/nextflow/wrappers/preprocessing/neighbors/main.nf"
find_neighbors = find_neighbors_viashalias.run(key: "find_neighbors")
