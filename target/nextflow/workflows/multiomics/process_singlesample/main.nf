// process_singlesample qc-workflow-with-quantile-filtering_build
// 
...
meta = [
    ...
    },
    {
      ...
      "arguments" : [
        ...
        },
        {
          ...
          "description" : "Minimum percentile of counts captured per cell.\n",
          "example" : [
            0.05
          ],
          "required" : false,
    ...
    },
    {
      ...
      "arguments" : [
        ...
        },
        {
          ...
          "description" : "Maximum number of counts per cell.",
          "example" : [
            5000000
          ],
          "required" : false,
  ...
  "build_info" : {
    "config" : "/home/runner/work/openpipeline/openpipeline/src/workflows/multiomics/process_singlesample/config.vsh.yaml",
    "runner" : "nextflow",
    "engine" : "native",
