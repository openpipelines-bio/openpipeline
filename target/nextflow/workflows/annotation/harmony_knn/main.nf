      ...
      "arguments" : [
        {
          "type" : "double",
          "name" : "--harmony_theta",
          "description" : "Diversity clustering penalty parameter. Can be set as a single value for all batch observations or as multiple values, one for each observation in the batches defined by --input_obs_batch_label. theta=0 does not encourage any diversity. Larger values of theta result in more diverse clusters.\\"\n",
          "default" : [
            2.0
          ],
          "required" : false,
...
include { highly_variable_genes as highly_variable_features_viashalias } from "${meta.root_dir}/dependencies/vsh/vsh/openpipeline_rapids/v0.1.3/_private/nextflow/wrappers/preprocessing/highly_variable_genes/main.nf"
highly_variable_features = highly_variable_features_viashalias.run(key: "highly_variable_features")
