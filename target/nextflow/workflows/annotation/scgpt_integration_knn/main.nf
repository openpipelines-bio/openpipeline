// scgpt_integration_knn annotation-workflow_build
// 
    ...
    "argument_groups" : [
      ...
      },
      {
        ...
        "arguments" : [
          ...
          {
            "type" : "string",
            "name" : "--var_gene_names_query",
            "description" : "The name of the query data var column containing gene names; when no gene_name_layer is provided, the var index will be used.\n",
            "required" : false,
            "direction" : "input",
            "multiple" : false,
            "multiple_sep" : ":",
        ...
        "arguments" : [
          {
            "type" : "file",
            "name" : "--reference",
            "description" : "Reference dataset consisting of the labeled observations. The dataset is expected to be pre-processed in the same way as the --input query dataset(s).\n",
            "example" : [
              "reference.h5mu"
            ],
            "must_exist" : true,
          ...
          {
            "type" : "string",
            "name" : "--var_gene_names_reference",
            "description" : "The name of the reference data var column containing gene names; when no gene_name_layer is provided, the var index will be used.\n",
            "required" : false,
            "direction" : "input",
            "multiple" : false,
            "multiple_sep" : ":",
    ...
    "resources" : [
      {
        ...
        "path" : "main.nf",
        "is_executable" : true,
        "parent" : "file:/home/runner/work/openpipeline/openpipeline/src/workflows/annotation/scgpt_integration_knn/",
        "entrypoint" : "run_wf"
      },
      {
        "type" : "file",
    ...
    "dependencies" : [
      {
        ...
        "foundConfigPath" : "/home/runner/work/openpipeline/openpipeline/src/workflows/integration/scgpt_leiden/config.vsh.yaml",
        "configInfo" : {
          "functionalityName" : "scgpt_leiden",
          ...
          "executable" : "/nextflow/workflows/integration/scgpt_leiden/main.nf"
        },
        "writtenPath" : "/home/runner/work/openpipeline/openpipeline/target/nextflow/workflows/integration/scgpt_leiden"
      },
      {
      ...
      {
        "name" : "metadata/rename_var",
        "repository" : {
          "type" : "local",
          "localPath" : ""
        },
        "foundConfigPath" : "/home/runner/work/openpipeline/openpipeline/src/metadata/rename_var/config.vsh.yaml",
        "configInfo" : {
          "functionalityName" : "rename_var",
          "git_tag" : "0.2.0-1630-gb55e6ab01d",
          "git_remote" : "https://github.com/openpipelines-bio/openpipeline",
          "viash_version" : "0.8.6",
          ...
          "platform" : "",
          "git_commit" : "b55e6ab01d1acfc3e3eed55dda376684c3964e24",
          "executable" : "/nextflow/metadata/rename_var/main.nf"
        },
        "writtenPath" : "/home/runner/work/openpipeline/openpipeline/target/nextflow/metadata/rename_var"
      },
      {
...
include { scgpt_leiden as scgpt_leiden_workflow_viashalias } from "${meta.resources_dir}/../../../../nextflow/workflows/integration/scgpt_leiden/main.nf"
scgpt_leiden_workflow = scgpt_leiden_workflow_viashalias.run(key: "scgpt_leiden_workflow")
...
include { rename_var } from "${meta.resources_dir}/../../../../nextflow/metadata/rename_var/main.nf"
