// scgpt_integration_knn scgpt-knn_build
// 
    ...
    },
    {
      ...
      "arguments" : [
        ...
        },
        {
          ...
          "description" : "Key in the model file containing the pretrained checkpoints. Must be provided when `--model` is a fine-tuned model.\n",
          "example" : [
            "model_state_dict"
          ],
          "required" : false,
...
include { copy_var } from "${meta.resources_dir}/../../../../nextflow/metadata/copy_var/main.nf"
