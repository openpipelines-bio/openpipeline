// scgpt_cell_type_annotation integration_build
// 
...
// 
// Component authors:
//  * Jakub Majercik (author, maintainer)
...
meta = [
  ...
  "functionality" : {
    ...
    "argument_groups" : [
      {
        ...
        "arguments" : [
          ...
          },
          {
            ...
            "example" : [
              "resources_test/scgpt/source/best_model.pt"
            ],
            "must_exist" : true,
            "create_parent" : true,
            "required" : true,
          ...
          },
          {
            ...
            "example" : [
              "resources_test/scgpt/source/args.json"
            ],
            "must_exist" : true,
            "create_parent" : true,
            "required" : true,
      ...
      },
      {
        ...
        "arguments" : [
          ...
          {
            "type" : "string",
            "name" : "--obs_predicted_cell_type",
            "description" : "The name of the adata.obs column to write predicted cell types to.\n",
            "default" : [
              "predicted_cell_type"
            ],
            "required" : false,
    ...
    "resources" : [
      {
        ...
        "path" : "main.nf",
        "is_executable" : true,
        "parent" : "file:/home/runner/work/openpipeline/openpipeline/src/workflows/annotation/scgpt_cell_type_annotation/",
        "entrypoint" : "run_wf"
      },
      {
        "type" : "file",
    ...
    "description" : "scGPT cell type annotation through decoding of cell embeddings.",
    "test_resources" : [
      {
        "type" : "nextflow_script",
        "path" : "test.nf",
    ...
    "dependencies" : [
      ...
      },
      {
        ...
        "foundConfigPath" : "/home/runner/work/openpipeline/openpipeline/src/scgpt/cell_type_annotation/config.vsh.yaml",
        "configInfo" : {
          "functionalityName" : "cell_type_annotation",
          "git_tag" : "",
          "git_remote" : "https://github.com/openpipelines-bio/openpipeline",
          "viash_version" : "0.8.5",
          "config" : "/home/runner/work/openpipeline/openpipeline/src/scgpt/cell_type_annotation/config.vsh.yaml",
          "functionalityNamespace" : "scgpt",
          "output" : "",
          "platform" : "",
          "git_commit" : "28c4dae4756794a67bc4eb00647f16830039b459",
  ...
  "info" : {
    "config" : "/home/runner/work/openpipeline/openpipeline/src/workflows/annotation/scgpt_cell_type_annotation/config.vsh.yaml",
    "platform" : "nextflow",
...
include { cell_type_annotation } from "${meta.resources_dir}/../../../../nextflow/scgpt/cell_type_annotation/main.nf"
