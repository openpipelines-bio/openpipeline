// scanvi_scarches scanvi-annotation-wf_build
// 
...
meta = [
  ...
  "dependencies" : [
    ...
    {
      "name" : "reference_mapping/scarches",
      "repository" : {
        "type" : "local"
      }
    },
...
include { scarches } from "${meta.resources_dir}/../../../../nextflow/reference_mapping/scarches/main.nf"
