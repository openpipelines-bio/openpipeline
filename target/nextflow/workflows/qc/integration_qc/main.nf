// integration_qc integration-qc_build
// 
...
meta = [
  ...
  "functionality" : {
    ...
    "argument_groups" : [
      {
        ...
        "arguments" : [
          ...
          },
          {
            "type" : "string",
            "name" : "--obs_cell_label",
            "description" : "The name of the adata obs column containing the cell type labels.\n",
            "example" : [
              "cell_type"
            ],
            "required" : true,
          ...
          },
          {
            "type" : "string",
            "name" : "--obs_cluster",
            "description" : "The name of the adata obs column containing the cluster labels.\n",
            "example" : [
              "cluster"
            ],
            "required" : true,
          ...
          },
          {
            ...
            "description" : "The name of the adata obsp object containing the neighbor connectivities.\n",
            "example" : [
              "connectivities"
            ],
            "required" : true,
          ...
          },
          {
            "type" : "string",
            "name" : "--uns_neighbors",
            "description" : "The name of the adata uns object containing the neighbors information.",
            "example" : [
              "neighbors"
            ],
            "required" : true,
        ...
        "arguments" : [
          {
            "type" : "file",
            "name" : "--output",
            "description" : "Output h5mu file with annotated integration metrics.",
            "example" : [
              "output.h5mu"
            ],
            "must_exist" : true,
    ...
    "resources" : [
      {
        ...
        "path" : "main.nf",
        "is_executable" : true,
        "parent" : "file:/home/runner/work/openpipeline/openpipeline/src/workflows/qc/integration_qc/",
        "entrypoint" : "run_wf"
      },
      {
        "type" : "file",
    ...
    "description" : "Workflow to add integration qc metrics to a MuData and generate an integration qc output report.\n  \n",
    "test_resources" : [
      {
        "type" : "file",
  ...
  "info" : {
    "config" : "/home/runner/work/openpipeline/openpipeline/src/workflows/qc/integration_qc/config.vsh.yaml",
    "platform" : "nextflow",
...
include { integration_metrics } from "${meta.resources_dir}/../../../../nextflow/qc/integration_metrics/main.nf"
include { integration_report } from "${meta.resources_dir}/../../../../nextflow/qc/integration_report/main.nf"
