// pseudobulk_deseq2 qc-workflow-with-quantile-filtering_build
// 
...
meta = [
  ...
  "argument_groups" : [
    {
      ...
      "arguments" : [
        ...
        },
        {
          "type" : "string",
          "name" : "--var_gene_names",
          "description" : "Name of the .var field that contains gene symbols. If not provided, .var.index will be used.\n",
          "example" : [
            "gene_symbol"
          ],
          "required" : false,
  ...
  "build_info" : {
    "config" : "/home/runner/work/openpipeline/openpipeline/src/workflows/differential_expression/pseudobulk_deseq2/config.vsh.yaml",
    "runner" : "nextflow",
    "engine" : "native",
...
include { create_pseudobulk } from "${meta.resources_dir}/../../../../nextflow/differential_expression/create_pseudobulk/main.nf"
include { deseq2 } from "${meta.resources_dir}/../../../../nextflow/differential_expression/deseq2/main.nf"
include { filter_with_counts } from "${meta.resources_dir}/../../../../nextflow/filter/filter_with_counts/main.nf"
include { filter_with_pattern } from "${meta.resources_dir}/../../../../nextflow/filter/filter_with_pattern/main.nf"
include { delimit_counts } from "${meta.resources_dir}/../../../../_private/nextflow/filter/delimit_counts/main.nf"
