// bd_rhapsody update_viash_actions_for_github_build
// 
    ...
    "resources" : [
      {
        ...
        "path" : "main.nf",
        "is_executable" : true,
        "parent" : "file:/home/runner/work/openpipeline/openpipeline/src/workflows/ingestion/bd_rhapsody/",
        "entrypoint" : "run_wf"
      },
      {
        "type" : "file",
...
include { bd_rhapsody as bd_rhapsody_component_viashalias } from "${meta.resources_dir}/../../../../nextflow/mapping/bd_rhapsody/main.nf"
bd_rhapsody_component = bd_rhapsody_component_viashalias.run(key: "bd_rhapsody_component")
include { from_bdrhap_to_h5mu } from "${meta.resources_dir}/../../../../nextflow/convert/from_bdrhap_to_h5mu/main.nf"
