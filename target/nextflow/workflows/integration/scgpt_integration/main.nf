// scgpt_integration scgpt-preprocessor_build
// 
...
meta = [
    ...
    "argument_groups" : [
      {
        ...
        "arguments" : [
          ...
          },
          {
            ...
            "example" : [
              "resources_test/scgpt/best_model.pt"
            ],
            "must_exist" : true,
            "create_parent" : true,
            "required" : true,
          ...
          },
          {
            "type" : "string",
            "name" : "--var_gene_names",
            "description" : "The name of the adata.var column containing gene names.\n",
            "default" : [
              "gene_name"
            ],
            "required" : false,
    ...
    "resources" : [
      {
        ...
        "path" : "main.nf",
        "is_executable" : true,
        "parent" : "file:/home/runner/work/openpipeline/openpipeline/src/workflows/integration/scgpt_integration/",
        "entrypoint" : "run_wf"
      },
      {
        "type" : "file",
  ...
  "info" : {
    "config" : "/home/runner/work/openpipeline/openpipeline/src/workflows/integration/scgpt_integration/config.vsh.yaml",
    "platform" : "nextflow",
