// totalvi_scarches_leiden qc-workflow-with-quantile-filtering_build
// 
...
meta = [
  ...
  "dependencies" : [
    {
      "name" : "integrate/totalvi_scarches",
      "repository" : {
        "type" : "local"
      }
    },
  ...
  "build_info" : {
    "config" : "/home/runner/work/openpipeline/openpipeline/src/workflows/integration/totalvi_scarches_leiden/config.vsh.yaml",
    "runner" : "nextflow",
    "engine" : "native",
...
include { totalvi_scarches } from "${meta.resources_dir}/../../../../nextflow/integrate/totalvi_scarches/main.nf"
