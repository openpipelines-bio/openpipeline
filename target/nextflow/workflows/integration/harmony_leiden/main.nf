...
include { harmony_integrate as harmony_integrate_viashalias } from "${meta.root_dir}/dependencies/vsh/vsh/openpipeline_rapids/v0.1.3/_private/nextflow/wrappers/preprocessing/harmony_integrate/main.nf"
harmony_integrate = harmony_integrate_viashalias.run(key: "harmony_integrate")
    ...
    | move_mudata_obsm_to_tiledb.run(
      ...
      fromState: {id, state ->
        [
          ...
          "endpoint": state.tiledb_endpoint,
          "output_modality": state.modality,
          "obsm_input": [state.obsm_umap, state.obsm_integrated],
