// scanvi_model integration_build
// 
...
meta = [
  ...
  "argument_groups" : [
    {
      ...
      "arguments" : [
        ...
        },
        {
          ...
          "description" : "Value in the --obs_batch_label field that indicates unlabeled observations\n",
          "default" : [
            "Unknown"
          ],
          "required" : false,
    ...
    },
    {
      ...
      "arguments" : [
        ...
        {
          "type" : "string",
          "name" : "--output_obsm_integrated_scvi",
          "description" : "The .obsm field in the output h5mu object where the scVI latent representation will be stored.",
          "default" : [
            "X_integrated_scvi"
          ],
          "required" : false,
        ...
        {
          "type" : "string",
          "name" : "--output_obsm_integrated_scanvi",
  ...
  "info" : {
    ...
    "test_dependencies" : [
      {
        "name" : "scanvi_embedding_model_test",
  ...
  "build_info" : {
    "config" : "/home/runner/work/openpipeline/openpipeline/src/workflows/embedding_model/scanvi_model/config.vsh.yaml",
    "runner" : "nextflow",
    "engine" : "native",
