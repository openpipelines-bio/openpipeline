...
$( if [ ! -z ${VIASH_PAR_FILTERED_H5+x} ]; then echo "${VIASH_PAR_FILTERED_H5}" | sed "s#'#'\\"'\\"'#g;s#.*#par_filtered_h5='&'#" ; fi )
$( if [ ! -z ${VIASH_PAR_METRICS_SUMMARY+x} ]; then echo "${VIASH_PAR_METRICS_SUMMARY}" | sed "s#'#'\\"'\\"'#g;s#.*#par_metrics_summary='&'#" ; fi )
$( if [ ! -z ${VIASH_PAR_MOLECULE_INFO+x} ]; then echo "${VIASH_PAR_MOLECULE_INFO}" | sed "s#'#'\\"'\\"'#g;s#.*#par_molecule_info='&'#" ; fi )
$( if [ ! -z ${VIASH_PAR_BAM+x} ]; then echo "${VIASH_PAR_BAM}" | sed "s#'#'\\"'\\"'#g;s#.*#par_bam='&'#" ; fi )
$( if [ ! -z ${VIASH_PAR_BAI+x} ]; then echo "${VIASH_PAR_BAI}" | sed "s#'#'\\"'\\"'#g;s#.*#par_bai='&'#" ; fi )
$( if [ ! -z ${VIASH_PAR_RAW_H5+x} ]; then echo "${VIASH_PAR_RAW_H5}" | sed "s#'#'\\"'\\"'#g;s#.*#par_raw_h5='&'#" ; fi )
