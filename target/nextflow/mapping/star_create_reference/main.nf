// star_create_reference main_build
// 
...
thisConfig = processConfig(jsonSlurper.parseText('''{
    ...
    "resources" : [
      {
        ...
        "path" : "script.py",
        "is_executable" : true,
        "parent" : "file:/home/runner/work/openpipeline/openpipeline/src/mapping/star_create_reference/config.vsh.yml"
      }
    ],
  ...
  "info" : {
    "config" : "/home/runner/work/openpipeline/openpipeline/src/mapping/star_create_reference/config.vsh.yml",
    "platform" : "nextflow",
    "viash_version" : "0.6.6",
...
par = {
  'input_fasta': $( if [ ! -z ${VIASH_PAR_INPUT_FASTA+x} ]; then echo "r'${VIASH_PAR_INPUT_FASTA//\\'/\\'\\"\\'\\"r\\'}'.split(' ')"; else echo None; fi ),
  'input_gtf': $( if [ ! -z ${VIASH_PAR_INPUT_GTF+x} ]; then echo "r'${VIASH_PAR_INPUT_GTF//\\'/\\'\\"\\'\\"r\\'}'"; else echo None; fi ),
...
thisDefaultProcessArgs = [
  ...
  "container" : {
    "registry" : "ghcr.io",
    "image" : "openpipelines-bio/mapping_star_create_reference",
    "tag" : "main_build"
  },
  "label" : [
    "highmem",
