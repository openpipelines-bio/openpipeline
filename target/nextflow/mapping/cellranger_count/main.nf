...
thisHelpMessage = '''cellranger_count main_build
...
Options:
    --input
        type: file
        example: fastq_dir
        Path of folder created by mkfastq or bcl2fastq

    --id
        type: string
        default: cr
        Output folder for the count files.

    --libraries
        type: file
        File containing the library definitions

    --feature_ref
        type: file
        File containing the barcode info
    ...
    --output
        ...
        example: output
        Path to cellranger output folder

    --log
        type: string
        default: log.txt
        Path to the log file (stdout and stderr)'''
