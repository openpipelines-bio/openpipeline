// bd_rhapsody_wta_1_10 main_build
// 
...
thisHelpMessage = '''bd_rhapsody_wta_1_10 main_build

A wrapper for the BD Rhapsody Analysis CWL v1.10.0 pipeline.
...
there are additional transgene sequences used in the experiment.
    ...
    --putative_cell_call
        ...
        choices:
            - mRNA
            - AbSeq_Experimental
        Specify the dataset to be used for putative cell calling. For putative
...
desired sample name to appear in Sample_Tag_Metrics.csv
    ...
    --run_name
        type: string
        example: run-name
        Specify a run name to use as the output file base name. Use only
...
thisDefaultProcessArgs = [
  ...
  "container" : {
    "registry" : "ghcr.io",
    "image" : "openpipelines-bio/mapping_bd_rhapsody_wta_1_10",
    "tag" : "main_build"
  },
  "label" : [
    "highmem",
