...
thisConfig = processConfig(jsonSlurper.parseText('''{
    ...
    "resources" : [
      {
        ...
        "path" : "script.py",
        "is_executable" : true,
        "parent" : "file:/home/di/code/openpipeline/src/mapping/cellranger_multi/config.vsh.yaml"
      }
    ],
  ...
  "info" : {
    "config" : "/home/di/code/openpipeline/src/mapping/cellranger_multi/config.vsh.yaml",
    "platform" : "nextflow",
    "viash_version" : "0.7.1",
