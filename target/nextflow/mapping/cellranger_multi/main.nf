...
par = {
  ...
  'gex_reference': $( if [ ! -z ${VIASH_PAR_GEX_REFERENCE+x} ]; then echo "'${VIASH_PAR_GEX_REFERENCE//\\'/\\\\\\'}'"; else echo None; fi ),
  'vdj_reference': $( if [ ! -z ${VIASH_PAR_VDJ_REFERENCE+x} ]; then echo "'${VIASH_PAR_VDJ_REFERENCE//\\'/\\\\\\'}'"; else echo None; fi ),
  'feature_reference': $( if [ ! -z ${VIASH_PAR_FEATURE_REFERENCE+x} ]; then echo "'${VIASH_PAR_FEATURE_REFERENCE//\\'/\\\\\\'}'"; else echo None; fi ),
  'library_id': $( if [ ! -z ${VIASH_PAR_LIBRARY_ID+x} ]; then echo "'${VIASH_PAR_LIBRARY_ID//\\'/\\\\\\'}'.split(';')"; else echo None; fi ),
  'library_type': $( if [ ! -z ${VIASH_PAR_LIBRARY_TYPE+x} ]; then echo "'${VIASH_PAR_LIBRARY_TYPE//\\'/\\\\\\'}'.split(';')"; else echo None; fi ),
  'library_subsample': $( if [ ! -z ${VIASH_PAR_LIBRARY_SUBSAMPLE+x} ]; then echo "'${VIASH_PAR_LIBRARY_SUBSAMPLE//\\'/\\\\\\'}'.split(';')"; else echo None; fi ),
  'library_lanes': $( if [ ! -z ${VIASH_PAR_LIBRARY_LANES+x} ]; then echo "'${VIASH_PAR_LIBRARY_LANES//\\'/\\\\\\'}'.split(';')"; else echo None; fi ),
  'gex_expect_cells': $( if [ ! -z ${VIASH_PAR_GEX_EXPECT_CELLS+x} ]; then echo "int('${VIASH_PAR_GEX_EXPECT_CELLS//\\'/\\\\\\'}')"; else echo None; fi ),
  'gex_chemistry': $( if [ ! -z ${VIASH_PAR_GEX_CHEMISTRY+x} ]; then echo "'${VIASH_PAR_GEX_CHEMISTRY//\\'/\\\\\\'}'"; else echo None; fi ),
  'gex_secondary_analysis': $( if [ ! -z ${VIASH_PAR_GEX_SECONDARY_ANALYSIS+x} ]; then echo "'${VIASH_PAR_GEX_SECONDARY_ANALYSIS//\\'/\\\\\\'}'.lower() == 'true'"; else echo None; fi ),
  'gex_generate_bam': $( if [ ! -z ${VIASH_PAR_GEX_GENERATE_BAM+x} ]; then echo "'${VIASH_PAR_GEX_GENERATE_BAM//\\'/\\\\\\'}'.lower() == 'true'"; else echo None; fi ),
  'gex_include_introns': $( if [ ! -z ${VIASH_PAR_GEX_INCLUDE_INTRONS+x} ]; then echo "'${VIASH_PAR_GEX_INCLUDE_INTRONS//\\'/\\\\\\'}'.lower() == 'true'"; else echo None; fi ),
  'cell_multiplex_sample_id': $( if [ ! -z ${VIASH_PAR_CELL_MULTIPLEX_SAMPLE_ID+x} ]; then echo "'${VIASH_PAR_CELL_MULTIPLEX_SAMPLE_ID//\\'/\\\\\\'}'"; else echo None; fi ),
  'cell_multiplex_oligo_ids': $( if [ ! -z ${VIASH_PAR_CELL_MULTIPLEX_OLIGO_IDS+x} ]; then echo "'${VIASH_PAR_CELL_MULTIPLEX_OLIGO_IDS//\\'/\\\\\\'}'"; else echo None; fi ),
  'cell_multiplex_description': $( if [ ! -z ${VIASH_PAR_CELL_MULTIPLEX_DESCRIPTION+x} ]; then echo "'${VIASH_PAR_CELL_MULTIPLEX_DESCRIPTION//\\'/\\\\\\'}'"; else echo None; fi ),
