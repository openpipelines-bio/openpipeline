// cellranger_atac_count integration_build
// 
    ...
    "resources" : [
      {
        ...
        "path" : "script.sh",
        "is_executable" : true,
        "parent" : "file:/home/runner/work/openpipeline/openpipeline/src/mapping/cellranger_atac_count/"
      },
      {
        "type" : "file",
...
$( if [ ! -z ${VIASH_PAR_PEAKS+x} ]; then echo "${VIASH_PAR_PEAKS}" | sed "s#'#'\\"'\\"'#g;s#.*#par_peaks='&'#" ; else echo "# par_peaks="; fi )
$( if [ ! -z ${VIASH_PAR_DIM_REDUCE+x} ]; then echo "${VIASH_PAR_DIM_REDUCE}" | sed "s#'#'\\"'\\"'#g;s#.*#par_dim_reduce='&'#" ; else echo "# par_dim_reduce="; fi )
$( if [ ! -z ${VIASH_PAR_SUBSAMPLE_RATE+x} ]; then echo "${VIASH_PAR_SUBSAMPLE_RATE}" | sed "s#'#'\\"'\\"'#g;s#.*#par_subsample_rate='&'#" ; else echo "# par_subsample_rate="; fi )
...
meta["defaults"] = [
  ...
  "container" : {
    "registry" : "ghcr.io",
    "image" : "openpipelines-bio/mapping/cellranger_atac_count",
