...
thisConfig = processConfig(jsonSlurper.parseText('''{
      ...
      },
      {
        ...
        "arguments" : [
          ...
          },
          {
            ...
            "description" : "minimum overhang (i.e. block size) for annotated (sj''' + '''db) spliced alignments",
            "example" : [
              3
            ],
            "required" : false,
    ...
    "resources" : [
      {
        ...
        "path" : "script.py",
        "is_executable" : true,
        "parent" : "file:/home/di/code/openpipeline/src/mapping/star_align/config.vsh.yaml"
      }
    ],
  ...
  "info" : {
    "config" : "/home/di/code/openpipeline/src/mapping/star_align/config.vsh.yaml",
    "platform" : "nextflow",
    "viash_version" : "0.7.1",
