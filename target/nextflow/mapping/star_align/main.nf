// star_align update_viash_actions_for_github_build
// 
      ...
      },
      {
        ...
        "arguments" : [
          ...
          },
          {
            ...
            "description" : "minimum overhang (i.e. block size) for spliced a''' + '''lignments",
            "example" : [
              5
            ],
            "required" : false,
...
meta["defaults"] = [
  ...
  "container" : {
    "registry" : "ghcr.io",
    "image" : "openpipelines-bio/mapping/star_align",
    "tag" : "main_build"
  },
  "label" : [
    "highmem",
