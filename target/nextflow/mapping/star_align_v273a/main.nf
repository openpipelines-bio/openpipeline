    ...
    },
    {
      ...
      "arguments" : [
        ...
        },
        {
          ...
          "description" : "max number of bins between two anchors that allows aggregation o''' + '''f anchors into one window",
          "example" : [
            9
          ],
          "required" : false,
...
meta["defaults"] = [
  ...
  "container" : {
    "registry" : "ghcr.io",
    "image" : "openpipelines-bio/openpipeline/mapping/star_align_v273a",
