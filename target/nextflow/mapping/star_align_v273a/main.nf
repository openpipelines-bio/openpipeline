    ...
    "argument_groups" : [
      {
        ...
        "arguments" : [
          ...
          },
          {
            ...
            "description" : "Path to the reference built by star_create_reference. Corresponds to the --genomeDir in the STAR command.",
            "example" : [
              "/path/to/reference"
            ],
            "must_exist" : true,
    ...
    "resources" : [
      {
        ...
        "is_executable" : true,
        "parent" : "file:/home/runner/work/openpipeline/openpipeline/src/mapping/star_align_v273a/config.vsh.yaml"
      }
    ],
