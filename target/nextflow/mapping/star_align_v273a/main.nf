...
thisConfig = processConfig(jsonSlurper.parseText('''{
      ...
      },
      {
        ...
        "arguments" : [
          ...
          },
          {
            ...
            "description" : "minimum overhang (i.e. block size) for annotated (sjdb) spliced alignment''' + '''s",
            "example" : [
              3
            ],
            "required" : false,
    ...
    "resources" : [
      {
        ...
        "is_executable" : true,
        "parent" : "file:/home/di/code/openpipeline/src/mapping/star_align_v273a/config.vsh.yaml"
      }
    ],
  ...
  "info" : {
    "config" : "/home/di/code/openpipeline/src/mapping/star_align_v273a/config.vsh.yaml",
    "platform" : "nextflow",
    "viash_version" : "0.7.1",
