// from_tiledb_to_h5mu qc-workflow-with-quantile-filtering_build
// 
...
meta = [
  ...
  "argument_groups" : [
    {
      ...
      "arguments" : [
        ...
        },
        {
          "type" : "string",
          "name" : "--input_layers",
          "description" : "Layers to import from TileDB-SOMA database.\n",
          "required" : true,
          "direction" : "input",
          "multiple" : true,
          "multiple_sep" : ";"
    ...
    },
    {
      ...
      "arguments" : [
        ...
        },
        {
          ...
          "description" : "Name of the modality to write the results to.\n",
          "required" : true,
          "direction" : "input",
          "multiple" : false,
          "multiple_sep" : ";"
  ...
  "build_info" : {
    "config" : "/home/runner/work/openpipeline/openpipeline/src/convert/from_tiledb_to_h5mu/config.vsh.yaml",
    "runner" : "nextflow",
    "engine" : "docker",
...
meta["defaults"] = [
  ...
  "container" : {
    "registry" : "ghcr.io",
    "image" : "openpipelines-bio/openpipeline/convert/from_tiledb_to_h5mu",
