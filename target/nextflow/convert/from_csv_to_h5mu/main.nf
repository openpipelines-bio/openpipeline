// from_csv_to_h5mu integration_build
// 
  ...
  "resources" : [
    {
      ...
      "path" : "./script.py",
      "is_executable" : true,
      "parent" : "file:/home/runner/work/openpipeline/openpipeline/src/convert/from_csv_to_h5mu/config.vsh.yaml"
    }
  ],
  "description" : "Converts an csv into an h5ad file.\n",
