// from_h5mu_to_seurat qc-workflow-with-quantile-filtering_build
// 
      ...
      "setup" : [
        ...
        },
        {
          ...
          "run" : [
            ...
            "Rscript -e 'options(warn = 2); remotes::install_github(c(\\"pmbio/MuDataSeurat@empty-tables-and-nullable\\"), repos = \\"https://cran.rstudio.com\\")'"
          ]
        }
      ]
    }
...
meta["defaults"] = [
  ...
  "container" : {
    "registry" : "ghcr.io",
    "image" : "openpipelines-bio/openpipeline/convert/from_h5mu_to_seurat",
