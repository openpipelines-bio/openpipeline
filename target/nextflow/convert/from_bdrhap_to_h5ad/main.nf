// from_bdrhap_to_h5ad main_build
// 
...
thisFunctionality = [
  ...
  'arguments': [
    [
      ...
      'type': 'file',
      'direction': 'input',
      'description': 'One or more folders containing the output of the BD Rhapsody workflow. If multiple are given, they are all combined into one h5ad file.',
      'example': ['input_dir'],
      'multiple': true,
      'multiple_sep': ':'
    ],
...
thisHelpMessage = '''from_bdrhap_to_h5ad main_build

Create a h5ad file from BD Rhapsody output.
...
If multiple are given, they are all combined into one h5ad file.
    ...
    --id
        ...
        example: my_id
        A vector of ids with same length as --input.
...
thisDefaultProcessArgs = [
  ...
  "container" : {
    "registry" : "ghcr.io",
    "image" : "openpipelines-bio/convert_from_bdrhap_to_h5ad",
    "tag" : "main_build"
  }
}"""),
  // auto settings
