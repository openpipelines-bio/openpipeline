...
thisConfig = processConfig(jsonSlurper.parseText('''{
    ...
    "resources" : [
      {
        ...
        "path" : "script.py",
        "is_executable" : true,
        "parent" : "file:/home/runner/work/openpipeline/openpipeline/src/velocity/velocyto_to_h5mu/config.vsh.yaml"
      }
    ],
  ...
  "info" : {
    ...
    "platform" : "nextflow",
    "viash_version" : "0.7.0",
    "git_commit" : "a5124bdfc121c6b01ab9ac3d372a4880bf6c2869",
...
thisDefaultProcessArgs = [
  ...
  "container" : {
    "registry" : "ghcr.io",
    "image" : "openpipelines-bio/convert/velocyto_to_h5mu",
    "tag" : "main_build"
  },
  "tag" : "$id"
}'''),
