...
// 
// Component authors:
//  * Dries Schaumont <dries@data-intuitive.com> (maintainer, author) {github:
// DriesSchaumont, orcid: 0000-0002-4389-0440}
//  * Robrecht Cannoodt <robrecht@data-intuitive.com> (author) {github: rcannood,
// orcid: 0000-0003-3641-729X}
//  * Angela Pisco (contributor) {github: aopisco, orcid: 0000-0003-0142-2355}
...
thisConfig = processConfig(jsonSlurper.parseText('''{
    ...
    "resources" : [
      {
        ...
        "path" : "script.py",
        "is_executable" : true,
        "parent" : "file:/home/di/code/openpipeline/src/velocity/velocyto_to_h5mu/config.vsh.yaml"
      }
    ],
  ...
  "info" : {
    "config" : "/home/di/code/openpipeline/src/velocity/velocyto_to_h5mu/config.vsh.yaml",
    "platform" : "nextflow",
    "viash_version" : "0.7.1",
    "git_commit" : "72762667f914995bfea2b8cba161ddfd1221a770",
    "git_remote" : "git@github.com:openpipelines-bio/openpipeline.git",
    "git_tag" : "0.2.0-1176-g72762667f"
  }
}'''))
