// from_h5mu_or_h5ad_to_tiledb qc-workflow-with-quantile-filtering_build
// 
...
meta = [
      ...
      "arguments" : [
        {
          "type" : "file",
          "name" : "--input",
          "description" : "Input AnnData or MuData file. When an AnnData file is provided, it is automatically assumed to \ncontain transcriptome counts.\n",
          "example" : [
            "input.h5mu"
          ],
          "must_exist" : true,
      ...
      "arguments" : [
        {
          "type" : "string",
          "name" : "--rna_modality",
          "description" : "The name used for the RNA modality. Used when input file is a MuData object.\n",
          "default" : [
            "rna"
          ],
          "required" : false,
        ...
        },
        {
          ...
          "description" : "Location of the layer containing the raw transcriptome counts. Layers are looked for in .layers,\nexcept when using the value 'X'; in which case .X is used.\n",
          "example" : [
            "X"
          ],
          "required" : true,
        ...
        },
        {
          ...
          "description" : "Location of the layer containing the normalized counts. Layers are looked for in .layers,\nexcept when using the value 'X'; in which case .X is used.\n",
          "example" : [
            "log_normalized"
          ],
          "required" : true,
        ...
        },
        {
          ...
          "description" : "Column in .var that provides the gene names. If not specified, the index from the input is used.\n",
          "example" : [
            "gene_symbol"
          ],
          "required" : false,
      ...
      "arguments" : [
        {
          "type" : "string",
          "name" : "--prot_modality",
          "description" : "The name used for the protein modality. Used when input file is a MuData object.\nWhen not specified, the protein modality will not be processed.\n",
          "example" : [
            "prot"
          ],
          "required" : false,
        ...
        },
        {
          ...
          "description" : "Location of the layer containing the raw protein counts. Layers are looked for in .layers,\nexcept when using the value 'X'; in which case .X is used.\n",
          "example" : [
            "X"
          ],
          "required" : false,
  ...
  "build_info" : {
    "config" : "/home/runner/work/openpipeline/openpipeline/src/convert/from_h5mu_or_h5ad_to_tiledb/config.vsh.yaml",
    "runner" : "nextflow",
    "engine" : "docker",
...
meta["defaults"] = [
  ...
  "container" : {
    "registry" : "ghcr.io",
    "image" : "openpipelines-bio/openpipeline/convert/from_h5mu_or_h5ad_to_tiledb",
