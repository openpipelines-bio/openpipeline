// from_bdrhap_to_h5mu qc-workflow-with-quantile-filtering_build
// 
...
def process_modality_inline(adata, modality):
    ...
    adata.obs.rename(
        columns={"Sample_Tag": "sample_tag", "Sample_Name": "sample_id"}, inplace=True
    )
    ...
    if modality == "rna":
        ...
        adata.var["reference_file"] = " & ".join(
            adata.uns["Pipeline_Inputs"]["AbSeq_Reference"]
        )
...
meta["defaults"] = [
  ...
  "container" : {
    "registry" : "ghcr.io",
    "image" : "openpipelines-bio/openpipeline/convert/from_bdrhap_to_h5mu",
