...
meta = [
  ...
  "engines" : [
    {
      ...
      "id" : "docker",
      "image" : "python:3.13",
      "target_tag" : "consensus-vote_build",
      "namespace_separator" : "/",
      "setup" : [
        {
          "type" : "python",
  ...
  "build_info" : {
    ...
    "viash_version" : "0.9.4",
    "git_commit" : "5acec18f031088c5d93832310e381c82d129e31b",
    "git_remote" : "https://github.com/openpipelines-bio/openpipeline",
    "git_tag" : "0.2.0-2127-g5acec18f031"
  },
  "package_config" : {
    "name" : "openpipeline",
    ...
    "config_mods" : [
      ...
      ".version := \\"consensus-vote_build\\"",
      ".engines[.type == 'docker'].target_tag := 'consensus-vote_build'"
    ],
    "keywords" : [
      "single-cell",
      "multimodal"
