...
meta = [
  ...
  "engines" : [
    {
      ...
      "id" : "docker",
      "image" : "python:3.10",
      "target_tag" : "debug_publish_build",
      "namespace_separator" : "/",
      "setup" : [
        {
          "type" : "python",
  ...
  "build_info" : {
    ...
    "viash_version" : "0.9.0",
    "git_commit" : "dd08f0bcc318a5b9cc08fa6ffe2f5a8ef29918d1",
    "git_remote" : "https://github.com/openpipelines-bio/openpipeline",
    "git_tag" : "0.2.0-1942-gdd08f0bcc3"
  },
  "package_config" : {
    "name" : "openpipeline",
    "version" : "dev",
    ...
    "config_mods" : [
      ...
      ".version := \\"debug_publish_build\\"",
      ".engines[.type == 'docker'].target_tag := 'debug_publish_build'"
    ],
