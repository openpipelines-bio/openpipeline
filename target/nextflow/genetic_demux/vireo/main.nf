...
meta = [
  ...
  "engines" : [
    {
      ...
      "id" : "docker",
      "image" : "python:3.10",
      "target_tag" : "seurat-to-h5mu_build",
      "namespace_separator" : "/",
      "setup" : [
        {
          "type" : "python",
  ...
  "build_info" : {
    ...
    "viash_version" : "0.9.4",
    "git_commit" : "aaddb98124f600d25fe89aa3054da4f88025eb1d",
    "git_remote" : "https://github.com/openpipelines-bio/openpipeline",
    "git_tag" : "0.2.0-2069-gaaddb98124f"
  },
  "package_config" : {
    "name" : "openpipeline",
    ...
    "config_mods" : [
      ...
      ".version := \\"seurat-to-h5mu_build\\"",
      ".engines[.type == 'docker'].target_tag := 'seurat-to-h5mu_build'"
    ],
    "keywords" : [
      "single-cell",
      "multimodal"
