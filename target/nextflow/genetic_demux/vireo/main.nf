// vireo parametrize-hvg-flavor_build
// 
...
meta = [
  ...
  "version" : "parametrize-hvg-flavor_build",
  "authors" : [
    {
      "name" : "Xichen Wu",
      "roles" : [
  ...
  "engines" : [
    {
      ...
      "id" : "docker",
      "image" : "python:3.10",
      "target_tag" : "parametrize-hvg-flavor_build",
      "namespace_separator" : "/",
      "setup" : [
        {
          "type" : "python",
  ...
  "build_info" : {
    ...
    "viash_version" : "0.9.0",
    "git_commit" : "c95cd38c523aae0f7df189383d33a3bf189ab7d7",
    "git_remote" : "https://github.com/openpipelines-bio/openpipeline",
    "git_tag" : "0.2.0-1994-gc95cd38c523"
  },
  "package_config" : {
    "name" : "openpipeline",
    "info" : {
    ...
    "config_mods" : [
      ...
      ".version := \\"parametrize-hvg-flavor_build\\"",
      ".engines[.type == 'docker'].target_tag := 'parametrize-hvg-flavor_build'"
    ],
...
meta["defaults"] = [
  ...
  "container" : {
    ...
    "tag" : "parametrize-hvg-flavor_build"
  },
  "label" : [
    "midmem",
    "midcpu"
