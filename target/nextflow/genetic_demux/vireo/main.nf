...
meta = [
  ...
  "engines" : [
    {
      ...
      "id" : "docker",
      "image" : "python:3.10",
      "target_tag" : "dtype_csr_fix_build",
      "namespace_separator" : "/",
      "setup" : [
        {
          "type" : "python",
  ...
  "build_info" : {
    ...
    "viash_version" : "0.9.0",
    "git_commit" : "8e249d6629bb9a50292707c10daaca8f7d03c0bd",
    "git_remote" : "https://github.com/openpipelines-bio/openpipeline",
    "git_tag" : "0.2.0-1940-g8e249d6629"
  },
  "package_config" : {
    "name" : "openpipeline",
    "version" : "dev",
    ...
    "config_mods" : [
      ...
      ".version := \\"dtype_csr_fix_build\\"",
      ".engines[.type == 'docker'].target_tag := 'dtype_csr_fix_build'"
    ],
