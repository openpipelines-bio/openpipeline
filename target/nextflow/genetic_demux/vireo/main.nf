// vireo add-lognormalization-to-celltypist_build
// 
...
meta = [
  ...
  "version" : "add-lognormalization-to-celltypist_build",
  "authors" : [
    {
      "name" : "Xichen Wu",
      "roles" : [
  ...
  "engines" : [
    {
      ...
      "id" : "docker",
      "image" : "python:3.10",
      "target_tag" : "add-lognormalization-to-celltypist_build",
      "namespace_separator" : "/",
      "setup" : [
        {
          "type" : "python",
  ...
  "build_info" : {
    ...
    "viash_version" : "0.9.4",
    "git_commit" : "c853100941602d517133a569640a19fd5e39e047",
    "git_remote" : "https://github.com/openpipelines-bio/openpipeline",
    "git_tag" : "0.2.0-2070-gc8531009416"
  },
  "package_config" : {
    "name" : "openpipeline",
    ...
    "config_mods" : [
      ...
      ".version := \\"add-lognormalization-to-celltypist_build\\"",
      ".engines[.type == 'docker'].target_tag := 'add-lognormalization-to-celltypist_build'"
    ],
    "keywords" : [
      "single-cell",
      "multimodal"
...
meta["defaults"] = [
  ...
  "container" : {
    ...
    "tag" : "add-lognormalization-to-celltypist_build"
  },
  "label" : [
    "midmem",
    "midcpu"
