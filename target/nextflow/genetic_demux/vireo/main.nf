// vireo fix-cellranger-sample-float-parsing_buld
// 
...
meta = [
  ...
  "version" : "fix-cellranger-sample-float-parsing_buld",
  "authors" : [
    {
      "name" : "Xichen Wu",
      "roles" : [
  ...
  "engines" : [
    {
      ...
      "id" : "docker",
      "image" : "python:3.13",
      "target_tag" : "fix-cellranger-sample-float-parsing_buld",
      "namespace_separator" : "/",
      "setup" : [
        {
          "type" : "python",
  ...
  "build_info" : {
    ...
    "viash_version" : "0.9.7",
    "git_commit" : "a3ef5cddb8d36f7df1450fd2789f62e23dd744fd",
    "git_remote" : "https://github.com/openpipelines-bio/openpipeline",
    "git_tag" : "0.2.0-2154-ga3ef5cddb8d"
  },
  "package_config" : {
    "name" : "openpipeline",
    ...
    "config_mods" : [
      ...
      ".version := \\"fix-cellranger-sample-float-parsing_buld\\"",
      ".engines[.type == 'docker'].target_tag := 'fix-cellranger-sample-float-parsing_buld'"
    ],
    "keywords" : [
      "single-cell",
      "multimodal"
...
meta["defaults"] = [
  ...
  "container" : {
    ...
    "tag" : "fix-cellranger-sample-float-parsing_buld"
  },
  "label" : [
    "midmem",
    "midcpu"
