// vireo scanvi-annotation-wf_build
// 
...
meta = [
  ...
  "version" : "scanvi-annotation-wf_build",
  "authors" : [
    {
      "name" : "Xichen Wu",
      "roles" : [
  ...
  "engines" : [
    {
      ...
      "id" : "docker",
      "image" : "python:3.10",
      "target_tag" : "scanvi-annotation-wf_build",
      "namespace_separator" : "/",
      "setup" : [
        {
          "type" : "python",
  ...
  "build_info" : {
    ...
    "viash_version" : "0.9.0",
    "git_commit" : "d4085105d8f2b2da414c449fe96db2752615356b",
    "git_remote" : "https://github.com/openpipelines-bio/openpipeline",
    "git_tag" : "0.2.0-2045-gd4085105d8f"
  },
  "package_config" : {
    "name" : "openpipeline",
    "info" : {
    ...
    "config_mods" : [
      ...
      ".version := \\"scanvi-annotation-wf_build\\"",
      ".engines[.type == 'docker'].target_tag := 'scanvi-annotation-wf_build'"
    ],
...
meta["defaults"] = [
  ...
  "container" : {
    ...
    "tag" : "scanvi-annotation-wf_build"
  },
  "label" : [
    "midmem",
    "midcpu"
