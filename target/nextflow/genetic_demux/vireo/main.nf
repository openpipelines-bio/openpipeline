// vireo scgpt-annotation-workflow_build
// 
...
meta = [
  ...
  "version" : "scgpt-annotation-workflow_build",
  "authors" : [
    {
      "name" : "Xichen Wu",
      "roles" : [
  ...
  "engines" : [
    {
      ...
      "id" : "docker",
      "image" : "python:3.10",
      "target_tag" : "scgpt-annotation-workflow_build",
      "namespace_separator" : "/",
      "setup" : [
        {
          "type" : "python",
  ...
  "package_config" : {
    ...
    "config_mods" : [
      ...
      ".version := \\"scgpt-annotation-workflow_build\\"",
      ".engines[.type == 'docker'].target_tag := 'scgpt-annotation-workflow_build'"
    ],
...
meta["defaults"] = [
  ...
  "container" : {
    ...
    "tag" : "scgpt-annotation-workflow_build"
  },
  "label" : [
    "midmem",
    "midcpu"
