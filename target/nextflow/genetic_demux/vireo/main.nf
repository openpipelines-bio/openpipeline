// vireo multi-flowcell-support_build
// 
...
meta = [
  ...
  "version" : "multi-flowcell-support_build",
  "authors" : [
    {
      "name" : "Xichen Wu",
      "roles" : [
  ...
  "engines" : [
    {
      ...
      "id" : "docker",
      "image" : "python:3.13",
      "target_tag" : "multi-flowcell-support_build",
      "namespace_separator" : "/",
      "setup" : [
        {
          "type" : "python",
  ...
  "build_info" : {
    ...
    "viash_version" : "0.9.7",
    "git_commit" : "d85885460d5ba2c5579c176b5071fe9407070d21",
    "git_remote" : "https://github.com/openpipelines-bio/openpipeline",
    "git_tag" : "0.2.0-2132-gd85885460d5"
  },
  "package_config" : {
    "name" : "openpipeline",
    ...
    "config_mods" : [
      ...
      ".version := \\"multi-flowcell-support_build\\"",
      ".engines[.type == 'docker'].target_tag := 'multi-flowcell-support_build'"
    ],
    "keywords" : [
      "single-cell",
      "multimodal"
...
meta["defaults"] = [
  ...
  "container" : {
    ...
    "tag" : "multi-flowcell-support_build"
  },
  "label" : [
    "midmem",
    "midcpu"
