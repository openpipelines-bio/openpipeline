// vireo support-filtered-h5-conversion_build
// 
...
meta = [
  ...
  "version" : "support-filtered-h5-conversion_build",
  "authors" : [
    {
      "name" : "Xichen Wu",
      "roles" : [
  ...
  "engines" : [
    {
      ...
      "id" : "docker",
      "image" : "python:3.13",
      "target_tag" : "support-filtered-h5-conversion_build",
      "namespace_separator" : "/",
      "setup" : [
        {
          "type" : "python",
  ...
  "build_info" : {
    ...
    "viash_version" : "0.9.7",
    "git_commit" : "8cd8becf1da138727c70f60921643df2d9f9f7b8",
    "git_remote" : "https://github.com/openpipelines-bio/openpipeline",
    "git_tag" : "0.2.0-2163-g8cd8becf1da"
  },
  "package_config" : {
    "name" : "openpipeline",
    ...
    "config_mods" : [
      ...
      ".version := \\"support-filtered-h5-conversion_build\\"",
      ".engines[.type == 'docker'].target_tag := 'support-filtered-h5-conversion_build'"
    ],
    "keywords" : [
      "single-cell",
      "multimodal"
...
meta["defaults"] = [
  ...
  "container" : {
    ...
    "tag" : "support-filtered-h5-conversion_build"
  },
  "label" : [
    "midmem",
    "midcpu"
