// vireo update-seurat-to-h5mu_build
// 
...
meta = [
  ...
  "version" : "update-seurat-to-h5mu_build",
  "authors" : [
    {
      "name" : "Xichen Wu",
      "roles" : [
  ...
  "engines" : [
    {
      ...
      "id" : "docker",
      "image" : "python:3.10",
      "target_tag" : "update-seurat-to-h5mu_build",
      "namespace_separator" : "/",
      "setup" : [
        {
          "type" : "python",
  ...
  "build_info" : {
    ...
    "viash_version" : "0.9.4",
    "git_commit" : "39ad07c61069677d19a4ece9bd6f6b81f627c194",
    "git_remote" : "https://github.com/openpipelines-bio/openpipeline",
    "git_tag" : "0.2.0-2070-g39ad07c6106"
  },
  "package_config" : {
    "name" : "openpipeline",
    ...
    "config_mods" : [
      ...
      ".version := \\"update-seurat-to-h5mu_build\\"",
      ".engines[.type == 'docker'].target_tag := 'update-seurat-to-h5mu_build'"
    ],
    "keywords" : [
      "single-cell",
      "multimodal"
...
meta["defaults"] = [
  ...
  "container" : {
    ...
    "tag" : "update-seurat-to-h5mu_build"
  },
  "label" : [
    "midmem",
    "midcpu"
