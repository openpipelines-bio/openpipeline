...
meta = [
  ...
  "engines" : [
    {
      ...
      "id" : "docker",
      "image" : "python:3.10",
      "target_tag" : "h5ad_to_seurat_build",
      "namespace_separator" : "/",
      "setup" : [
        {
          "type" : "python",
  ...
  "build_info" : {
    ...
    "viash_version" : "0.9.0",
    "git_commit" : "af36ed84ffced08c6547aef8e516fceec1583468",
    "git_remote" : "https://github.com/openpipelines-bio/openpipeline",
    "git_tag" : "0.2.0-1992-gaf36ed84ffc"
  },
  "package_config" : {
    "name" : "openpipeline",
    "info" : {
    ...
    "config_mods" : [
      ...
      ".version := \\"h5ad_to_seurat_build\\"",
      ".engines[.type == 'docker'].target_tag := 'h5ad_to_seurat_build'"
    ],
