...
// 
// Component authors:
//  * Mauro Saporita <maurosaporita@gmail.com> (author) {github: mauro-saporita}
//  * Povilas Gibas <povilasgibas@gmail.com> (author) {github: PoGibas}
...
thisConfig = processConfig(jsonSlurper.parseText('''{
    ...
    "resources" : [
      {
        ...
        "path" : "script.py",
        "is_executable" : true,
        "parent" : "file:/home/di/code/openpipeline/src/interpret/lianapy/config.vsh.yaml"
      }
    ],
  ...
  "info" : {
    "config" : "/home/di/code/openpipeline/src/interpret/lianapy/config.vsh.yaml",
    "platform" : "nextflow",
    "viash_version" : "0.7.1",
