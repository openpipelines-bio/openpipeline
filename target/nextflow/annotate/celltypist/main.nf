// celltypist harmony-knn-annoation-workflow_build
// 
...
par = {
  ...
  'var_reference_gene_names': $( if [ ! -z ${VIASH_PAR_VAR_REFERENCE_GENE_NAMES+x} ]; then echo "r'${VIASH_PAR_VAR_REFERENCE_GENE_NAMES//\\'/\\'\\"\\'\\"r\\'}'"; else echo None; fi ),
