// singler qc-workflow-with-quantile-filtering_build
// 
...
meta = [
    ...
    },
    {
      ...
      "arguments" : [
        ...
        },
        {
          ...
          "description" : "In which `.obs` slot to store the delta between the best and next-best score. If `--fine_tune True`, this is reported for scores after fine-tuning.\n",
          "default" : [
            "singler_delta_next"
          ],
          "required" : false,
        ...
        },
        {
          ...
          "description" : "In which `.obs` slot to store the pruned labels, where low-quality labels are replaced with NA's. Only added if `--prune True`.\n",
          "default" : [
  ...
  "build_info" : {
    "config" : "/home/runner/work/openpipeline/openpipeline/src/annotate/singler/config.vsh.yaml",
    "runner" : "nextflow",
    "engine" : "docker",
...
meta["defaults"] = [
  ...
  "container" : {
    "registry" : "ghcr.io",
    "image" : "openpipelines-bio/openpipeline/annotate/singler",
