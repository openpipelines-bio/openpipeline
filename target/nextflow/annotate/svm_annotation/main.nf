// svm_annotation qc-workflow-with-quantile-filtering_build
// 
...
meta = [
  ...
  "build_info" : {
    "config" : "/home/runner/work/openpipeline/openpipeline/src/annotate/svm_annotation/config.vsh.yaml",
    "runner" : "nextflow",
    "engine" : "docker",
...
par = {
  ...
  'output_obs_prediction': $( if [ ! -z ${VIASH_PAR_OUTPUT_OBS_PREDICTION+x} ]; then echo "r'${VIASH_PAR_OUTPUT_OBS_PREDICTION//\\'/\\'\\"\\'\\"r\\'}'"; else echo None; fi ),
  ...
  'c_reg': $( if [ ! -z ${VIASH_PAR_C_REG+x} ]; then echo "float(r'${VIASH_PAR_C_REG//\\'/\\'\\"\\'\\"r\\'}')"; else echo None; fi ),
