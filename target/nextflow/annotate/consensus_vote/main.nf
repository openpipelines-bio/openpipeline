// consensus_vote qc-workflow-with-quantile-filtering_build
// 
...
meta = [
  ...
  "argument_groups" : [
    {
      ...
      "arguments" : [
        ...
        },
        {
          ...
          "description" : "One or more .obs column names containing cell type predictions (labels) from\ndifferent annotation methods.\n",
          "example" : [
            "scanvi_pred",
            "celltypist_pred"
          ],
        ...
        },
        {
          "type" : "string",
          "name" : "--tie_label",
          "description" : "Label to assign when two or more cell types receive equal votes.\nIf not provided, tied cells are assigned None (missing value).\n",
          "example" : [
            "Unknown"
          ],
          "required" : false,
    ...
    },
    {
      ...
      "arguments" : [
        ...
        },
        {
          ...
          "description" : "In which `.obs` slot to store the consensus predicted cell type.\n",
          "default" : [
            "consensus_pred"
          ],
          "required" : false,
        ...
        },
        {
          ...
          "description" : "In which `.obs` slot to store the consensus score, defined as the fraction\nof total weight assigned to the winning cell type.\n",
          "default" : [
            "consensus_score"
          ],
          "required" : false,
  ...
  "build_info" : {
    "config" : "/home/runner/work/openpipeline/openpipeline/src/annotate/consensus_vote/config.vsh.yaml",
    "runner" : "nextflow",
    "engine" : "docker",
    "output" : "/home/runner/work/openpipeline/openpipeline/target/nextflow/annotate/consensus_vote",
    "viash_version" : "0.9.7",
...
par = {
  ...
  'input_obs_predictions': $( if [ ! -z ${VIASH_PAR_INPUT_OBS_PREDICTIONS+x} ]; then echo "r'${VIASH_PAR_INPUT_OBS_PREDICTIONS//\\'/\\'\\"\\'\\"r\\'}'.split(';')"; else echo None; fi ),
  'input_obs_probabilities': $( if [ ! -z ${VIASH_PAR_INPUT_OBS_PROBABILITIES+x} ]; then echo "r'${VIASH_PAR_INPUT_OBS_PROBABILITIES//\\'/\\'\\"\\'\\"r\\'}'.split(';')"; else echo None; fi ),
  'tie_label': $( if [ ! -z ${VIASH_PAR_TIE_LABEL+x} ]; then echo "r'${VIASH_PAR_TIE_LABEL//\\'/\\'\\"\\'\\"r\\'}'"; else echo None; fi ),
  'weights': $( if [ ! -z ${VIASH_PAR_WEIGHTS+x} ]; then echo "list(map(float, r'${VIASH_PAR_WEIGHTS//\\'/\\'\\"\\'\\"r\\'}'.split(';')))"; else echo None; fi ),
  ...
  'output_obs_score': $( if [ ! -z ${VIASH_PAR_OUTPUT_OBS_SCORE+x} ]; then echo "r'${VIASH_PAR_OUTPUT_OBS_SCORE//\\'/\\'\\"\\'\\"r\\'}'"; else echo None; fi ),
...
meta["defaults"] = [
  ...
  "container" : {
    "registry" : "ghcr.io",
    "image" : "openpipelines-bio/openpipeline/annotate/consensus_vote",
