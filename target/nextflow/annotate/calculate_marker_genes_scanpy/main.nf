// calculate_marker_genes_scanpy integration_build
// 
...
meta = [
  ...
  "argument_groups" : [
    {
      ...
      "arguments" : [
        ...
        },
        {
          "type" : "string",
          "name" : "--input_layer",
          "description" : "Name of the layer to use. This should contain log-normalized data.\nIf not set, the .X matrix will be used.\n",
          "required" : false,
          "direction" : "input",
          "multiple" : false,
          "multiple_sep" : ";"
        },
        {
          "type" : "string",
          "name" : "--obs_clustering",
          "description" : "Name of the `.obs` column that contains cluster assignments to\ncalculate marker genes for.\n",
          "example" : [
            "leiden_0.5"
          ],
          "required" : true,
    ...
    },
    {
      ...
      "arguments" : [
        ...
        },
        {
          "type" : "string",
          "name" : "--corr_method",
          "description" : "Method used to correct p-values for multiple testing. Not used when\n`--method` is `logreg`.\n",
          "default" : [
            "benjamini-hochberg"
          ],
          "required" : false,
        ...
        },
        {
          "type" : "boolean",
          "name" : "--tie_correct",
          "description" : "Whether to apply tie correction to the Wilcoxon test statistic. Only\nused when `--method` is `wilcoxon`.\n",
          "default" : [
            false
          ],
          "required" : false,
      ...
      "arguments" : [
        {
          "type" : "boolean",
          "name" : "--filter_results",
          "description" : "Whether to filter the results of `rank_genes_groups()` using\n`filter_rank_genes_groups()`.\n",
          "default" : [
            false
          ],
          "required" : false,
        ...
        },
        {
          "type" : "boolean",
          "name" : "--compare_abs",
          "description" : "Whether to compare against absolute fold changes when filtering.\n",
          "default" : [
            false
          ],
          "required" : false,
  ...
  "description" : "Calculate marker genes for clusters in a MuData object using scanpy's\n`rank_genes_groups()` function.\n",
  "test_resources" : [
    {
      "type" : "python_script",
      "path" : "test.py",
  ...
  "build_info" : {
    "config" : "/home/runner/work/openpipeline/openpipeline/src/annotate/calculate_marker_genes_scanpy/config.vsh.yaml",
    "runner" : "nextflow",
    "engine" : "docker",
    "output" : "/home/runner/work/openpipeline/openpipeline/target/nextflow/annotate/calculate_marker_genes_scanpy",
    "viash_version" : "0.9.7",
...
par = {
  ...
  'obs_clustering': $( if [ ! -z ${VIASH_PAR_OBS_CLUSTERING+x} ]; then echo "r'${VIASH_PAR_OBS_CLUSTERING//\\'/\\'\\"\\'\\"r\\'}'"; else echo None; fi ),
  'output': $( if [ ! -z ${VIASH_PAR_OUTPUT+x} ]; then echo "r'${VIASH_PAR_OUTPUT//\\'/\\'\\"\\'\\"r\\'}'"; else echo None; fi ),
  'output_markers': $( if [ ! -z ${VIASH_PAR_OUTPUT_MARKERS+x} ]; then echo "r'${VIASH_PAR_OUTPUT_MARKERS//\\'/\\'\\"\\'\\"r\\'}'"; else echo None; fi ),
  ...
  'tie_correct': $( if [ ! -z ${VIASH_PAR_TIE_CORRECT+x} ]; then echo "r'${VIASH_PAR_TIE_CORRECT//\\'/\\'\\"\\'\\"r\\'}'.lower() == 'true'"; else echo None; fi ),
  'filter_results': $( if [ ! -z ${VIASH_PAR_FILTER_RESULTS+x} ]; then echo "r'${VIASH_PAR_FILTER_RESULTS//\\'/\\'\\"\\'\\"r\\'}'.lower() == 'true'"; else echo None; fi ),
  'min_in_group_fraction': $( if [ ! -z ${VIASH_PAR_MIN_IN_GROUP_FRACTION+x} ]; then echo "float(r'${VIASH_PAR_MIN_IN_GROUP_FRACTION//\\'/\\'\\"\\'\\"r\\'}')"; else echo None; fi ),
  'max_out_group_fraction': $( if [ ! -z ${VIASH_PAR_MAX_OUT_GROUP_FRACTION+x} ]; then echo "float(r'${VIASH_PAR_MAX_OUT_GROUP_FRACTION//\\'/\\'\\"\\'\\"r\\'}')"; else echo None; fi ),
  'min_fold_change': $( if [ ! -z ${VIASH_PAR_MIN_FOLD_CHANGE+x} ]; then echo "float(r'${VIASH_PAR_MIN_FOLD_CHANGE//\\'/\\'\\"\\'\\"r\\'}')"; else echo None; fi ),
  'compare_abs': $( if [ ! -z ${VIASH_PAR_COMPARE_ABS+x} ]; then echo "r'${VIASH_PAR_COMPARE_ABS//\\'/\\'\\"\\'\\"r\\'}'.lower() == 'true'"; else echo None; fi )
}
meta = {
...
def filter_marker_genes(adata, par):
    ...
    filtered_key_added = f"{par['uns_output']}_filtered"
...
def format_results(adata, par, filtered_key_added=None):
    results = sc.get.rank_genes_groups_df(adata, group=None, key=par["uns_output"])
...
meta["defaults"] = [
  ...
  "container" : {
    "registry" : "ghcr.io",
    "image" : "openpipelines-bio/openpipeline/annotate/calculate_marker_genes_scanpy",
