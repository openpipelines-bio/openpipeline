    ...
    "resources" : [
      {
        ...
        "path" : "script.sh",
        "is_executable" : true,
        "parent" : "file:/home/runner/work/openpipeline/openpipeline/src/download/sync_test_resources/config.vsh.yaml"
      }
    ],
...
thisDefaultProcessArgs = [
  ...
  "container" : {
    "registry" : "ghcr.io",
    "image" : "openpipelines-bio/download/sync_test_resources",
    "tag" : "0.7.1"
  },
  "tag" : "$id"
}'''),
