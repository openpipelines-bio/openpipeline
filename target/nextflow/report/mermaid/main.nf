...
thisHelpMessage = '''mermaid main_build

Generates a network from mermaid code. See
`https://mermaid-js.github.io/mermaid/#/Tutorials`. This component uses the
external mermaid.ink service to generate visual networks.
