  ...
  "resources" : [
    {
      ...
      "path" : "./script.py",
      "is_executable" : true,
      "parent" : "file:/home/rcannood/workspace/jnj/openpipeline_release/src/report/mermaid/config.vsh.yaml"
    }
  ],
  "description" : "Generates a network from mermaid code. See `https://mermaid-js.github.io/mermaid/#/Tutorials`. This component uses the external mermaid.ink service to generate visual networks.\n",
  "test_resources" : [
    {
      "type" : "python_script",
      "path" : "test.py",
...
par = {
  ...
  'test': $( if [ ! -z ${VIASH_PAR_TEST+x} ]; then echo "'${VIASH_PAR_TEST//\\'/\\\\\\'}'"; else echo None; fi )
}
meta = {
