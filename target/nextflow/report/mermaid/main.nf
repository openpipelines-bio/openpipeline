  ...
  "resources" : [
    {
      ...
      "path" : "./script.py",
      "is_executable" : true,
      "parent" : "file:/home/runner/work/openpipeline/openpipeline/src/report/mermaid/config.vsh.yaml"
    }
  ],
...
par = {
  ...
  'test': $( if [ ! -z ${VIASH_PAR_TEST+x} ]; then echo "r'${VIASH_PAR_TEST//\\'/\\'\\"\\'\\"r\\'}'"; else echo None; fi )
}
meta = {
