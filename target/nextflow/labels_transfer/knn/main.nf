// knn qc-workflow-with-quantile-filtering_build
// 
      ...
      "arguments" : [
        {
          ...
          "description" : "The `.obsm` key of the reference dataset containing pre-calculated distances. \nIf not provided, the distances will be calculated using PyNNDescent.\n",
          "example" : [
            "bbknn_distances"
          ],
          "required" : false,
...
par = {
  ...
  'input_obsm_distances': $( if [ ! -z ${VIASH_PAR_INPUT_OBSM_DISTANCES+x} ]; then echo "r'${VIASH_PAR_INPUT_OBSM_DISTANCES//\\'/\\'\\"\\'\\"r\\'}'"; else echo None; fi ),
  'reference_obsm_distances': $( if [ ! -z ${VIASH_PAR_REFERENCE_OBSM_DISTANCES+x} ]; then echo "r'${VIASH_PAR_REFERENCE_OBSM_DISTANCES//\\'/\\'\\"\\'\\"r\\'}'"; else echo None; fi ),
...
meta["defaults"] = [
  ...
  "container" : {
    "registry" : "ghcr.io",
    "image" : "openpipelines-bio/openpipeline/labels_transfer/knn",
