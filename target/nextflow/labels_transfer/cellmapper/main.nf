// cellmapper qc-workflow-with-quantile-filtering_build
// 
...
meta = [
  ...
  "argument_groups" : [
    ...
    {
      "name" : "CellMapper arguments",
      "arguments" : [
        {
          "type" : "integer",
          "name" : "--n_neighbors",
          "description" : "Number of neighbors used by CellMapper.\n",
          "default" : [
            15
          ],
          "required" : false,
        ...
        },
        {
          "type" : "string",
          "name" : "--kernel_method",
          "description" : "Method to use for computing the CellMapper mapping matrix.\n",
          "required" : false,
          "choices" : [
            "jaccard",
            "gauss",
  ...
  "description" : "Transfer labels from a reference to a query using CellMapper in a shared\nembedding space.\n",
  "test_resources" : [
    {
      "type" : "python_script",
      "path" : "test.py",
  ...
  "build_info" : {
    "config" : "/home/runner/work/openpipeline/openpipeline/src/labels_transfer/cellmapper/config.vsh.yaml",
    "runner" : "nextflow",
    "engine" : "docker",
...
meta["defaults"] = [
  ...
  "container" : {
    "registry" : "ghcr.io",
    "image" : "openpipelines-bio/openpipeline/labels_transfer/cellmapper",
