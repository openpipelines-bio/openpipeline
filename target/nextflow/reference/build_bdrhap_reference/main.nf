// build_bdrhap_reference qc-workflow-with-quantile-filtering_build
// 
  ...
  "argument_groups" : [
    {
      ...
      "arguments" : [
        ...
        },
        {
          ...
          "example" : [
            "extra_sequence_1.fa.gz",
            "extra_sequence_2.fa.gz"
          ],
          "must_exist" : true,
          "create_parent" : true,
          "required" : false,
...
meta["defaults"] = [
  ...
  "container" : {
    "registry" : "ghcr.io",
    "image" : "openpipelines-bio/openpipeline/reference/build_bdrhap_reference",
