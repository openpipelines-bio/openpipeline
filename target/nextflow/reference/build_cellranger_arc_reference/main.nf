// build_cellranger_arc_reference update_viash_actions_for_github_build
// 
    ...
    "resources" : [
      {
        ...
        "path" : "script.sh",
        "is_executable" : true,
        "parent" : "file:/home/runner/work/openpipeline/openpipeline/src/reference/build_cellranger_arc_reference/"
      },
      {
        "type" : "file",
...
$( if [ ! -z ${VIASH_PAR_MOTIFS_FILE+x} ]; then echo "${VIASH_PAR_MOTIFS_FILE}" | sed "s#'#'\\"'\\"'#g;s#.*#par_motifs_file='&'#" ; else echo "# par_motifs_file="; fi )
$( if [ ! -z ${VIASH_PAR_NON_NUCLEAR_CONTIGS+x} ]; then echo "${VIASH_PAR_NON_NUCLEAR_CONTIGS}" | sed "s#'#'\\"'\\"'#g;s#.*#par_non_nuclear_contigs='&'#" ; else echo "# par_non_nuclear_contigs="; fi )
...
meta["defaults"] = [
  ...
  "container" : {
    "registry" : "ghcr.io",
    "image" : "openpipelines-bio/reference/build_cellranger_arc_reference",
    "tag" : "main_build"
  },
  "label" : [
    "highmem",
