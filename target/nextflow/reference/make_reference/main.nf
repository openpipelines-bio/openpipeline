...
$( if [ ! -z ${VIASH_PAR_GENOME_FASTA+x} ]; then echo "par_genome_fasta='${VIASH_PAR_GENOME_FASTA//\\'/\\'\\"\\'\\"\\'}'"; fi )
$( if [ ! -z ${VIASH_PAR_TRANSCRIPTOME_GTF+x} ]; then echo "par_transcriptome_gtf='${VIASH_PAR_TRANSCRIPTOME_GTF//\\'/\\'\\"\\'\\"\\'}'"; fi )
$( if [ ! -z ${VIASH_PAR_ERCC+x} ]; then echo "par_ercc='${VIASH_PAR_ERCC//\\'/\\'\\"\\'\\"\\'}'"; fi )
$( if [ ! -z ${VIASH_PAR_SUBSET_REGEX+x} ]; then echo "par_subset_regex='${VIASH_PAR_SUBSET_REGEX//\\'/\\'\\"\\'\\"\\'}'"; fi )
$( if [ ! -z ${VIASH_PAR_OUTPUT_FASTA+x} ]; then echo "par_output_fasta='${VIASH_PAR_OUTPUT_FASTA//\\'/\\'\\"\\'\\"\\'}'"; fi )
$( if [ ! -z ${VIASH_PAR_OUTPUT_GTF+x} ]; then echo "par_output_gtf='${VIASH_PAR_OUTPUT_GTF//\\'/\\'\\"\\'\\"\\'}'"; fi )
