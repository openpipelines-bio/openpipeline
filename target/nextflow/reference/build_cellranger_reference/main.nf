// build_cellranger_reference dev
// 
...
thisConfig = processConfig(jsonSlurper.parseText('''{
    ...
    "resources" : [
      {
        ...
        "path" : "script.sh",
        "is_executable" : true,
        "parent" : "file:/home/di/code/openpipeline/src/reference/build_cellranger_reference/config.vsh.yaml"
      }
    ],
  ...
  "info" : {
    "config" : "/home/di/code/openpipeline/src/reference/build_cellranger_reference/config.vsh.yaml",
    "platform" : "nextflow",
    "viash_version" : "0.7.1",
