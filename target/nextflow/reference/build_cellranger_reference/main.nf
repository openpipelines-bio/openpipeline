// build_cellranger_reference qc-workflow-with-quantile-filtering_build
// 
...
$( if [ ! -z ${VIASH_PAR_REFERENCE_VERSION+x} ]; then echo "${VIASH_PAR_REFERENCE_VERSION}" | sed "s#'#'\\"'\\"'#g;s#.*#par_reference_version='&'#" ; else echo "# par_reference_version="; fi )
...
meta["defaults"] = [
  ...
  "container" : {
    "registry" : "ghcr.io",
    "image" : "openpipelines-bio/openpipeline/reference/build_cellranger_reference",
