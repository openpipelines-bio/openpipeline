// cellranger_mkgtf integration_build
// 
...
meta = [
    ...
    "resources" : [
      {
        ...
        "path" : "script.sh",
        "is_executable" : true,
        "parent" : "file:/home/runner/work/openpipeline/openpipeline/src/reference/cellranger_mkgtf/"
      },
      {
        "type" : "file",
  ...
  "info" : {
    "config" : "/home/runner/work/openpipeline/openpipeline/src/reference/cellranger_mkgtf/config.vsh.yaml",
    "platform" : "nextflow",
...
$( if [ ! -z ${VIASH_PAR_INPUT_GTF+x} ]; then echo "${VIASH_PAR_INPUT_GTF}" | sed "s#'#'\\"'\\"'#g;s#.*#par_input_gtf='&'#" ; else echo "# par_input_gtf="; fi )
$( if [ ! -z ${VIASH_PAR_OUTPUT_GTF+x} ]; then echo "${VIASH_PAR_OUTPUT_GTF}" | sed "s#'#'\\"'\\"'#g;s#.*#par_output_gtf='&'#" ; else echo "# par_output_gtf="; fi )
$( if [ ! -z ${VIASH_PAR_ATTRIBUTE+x} ]; then echo "${VIASH_PAR_ATTRIBUTE}" | sed "s#'#'\\"'\\"'#g;s#.*#par_attribute='&'#" ; else echo "# par_attribute="; fi )
...
meta["defaults"] = [
  ...
  "container" : {
    "registry" : "ghcr.io",
    "image" : "openpipelines-bio/reference/cellranger_mkgtf",
