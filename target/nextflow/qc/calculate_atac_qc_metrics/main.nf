// calculate_atac_qc_metrics qc-workflow-with-quantile-filtering_build
// 
...
meta = [
  ...
  "argument_groups" : [
    {
      ...
      "arguments" : [
        ...
        },
        {
          "type" : "file",
          "name" : "--fragments_path",
          "description" : "Path to the fragments file. If not provided and not present in the input h5mu file,\nthe nucleosome signal and TSS enrichment score will not be calculated.\n",
          "example" : [
            "fragments.tsv.gz"
          ],
          "must_exist" : true,
        ...
        },
        {
          "type" : "string",
          "name" : "--layer",
          "description" : "Layer at `.layers` to use for the calculation. If not provided, `.X` is used.\n",
          "example" : [
            "raw_counts"
          ],
          "required" : false,
        ...
        },
        {
          ...
          "description" : "Threshold for nucleosome signal. Cells with nucleosome signal above this threshold\nwill be marked as low quality (\\"NS_FAIL\\"), otherwise they will be marked \\"NS_PASS\\".\n",
          "default" : [
            2.0
          ],
          "required" : false,
        ...
        },
        {
          "type" : "double",
          "name" : "--tss_threshold",
          "description" : "Threshold for TSS enrichment score. Cells with TSS enrichment score below this threshold\nwill be marked as low quality (\\"TSS_FAIL\\") otherwise they will be marked as \\"TSS_PASS\\".\n",
          "default" : [
            1.5
          ],
          "required" : false,
  ...
  "build_info" : {
    "config" : "/home/runner/work/openpipeline/openpipeline/src/qc/calculate_atac_qc_metrics/config.vsh.yaml",
    "runner" : "nextflow",
    "engine" : "docker",
...
par = {
  ...
  'fragments_path': $( if [ ! -z ${VIASH_PAR_FRAGMENTS_PATH+x} ]; then echo "r'${VIASH_PAR_FRAGMENTS_PATH//\\'/\\'\\"\\'\\"r\\'}'"; else echo None; fi ),
  'modality': $( if [ ! -z ${VIASH_PAR_MODALITY+x} ]; then echo "r'${VIASH_PAR_MODALITY//\\'/\\'\\"\\'\\"r\\'}'"; else echo None; fi ),
  'layer': $( if [ ! -z ${VIASH_PAR_LAYER+x} ]; then echo "r'${VIASH_PAR_LAYER//\\'/\\'\\"\\'\\"r\\'}'"; else echo None; fi ),
  'n_fragments_for_nucleosome_signal': $( if [ ! -z ${VIASH_PAR_N_FRAGMENTS_FOR_NUCLEOSOME_SIGNAL+x} ]; then echo "int(r'${VIASH_PAR_N_FRAGMENTS_FOR_NUCLEOSOME_SIGNAL//\\'/\\'\\"\\'\\"r\\'}')"; else echo None; fi ),
  'nuc_signal_threshold': $( if [ ! -z ${VIASH_PAR_NUC_SIGNAL_THRESHOLD+x} ]; then echo "float(r'${VIASH_PAR_NUC_SIGNAL_THRESHOLD//\\'/\\'\\"\\'\\"r\\'}')"; else echo None; fi ),
  'n_tss': $( if [ ! -z ${VIASH_PAR_N_TSS+x} ]; then echo "int(r'${VIASH_PAR_N_TSS//\\'/\\'\\"\\'\\"r\\'}')"; else echo None; fi ),
  'tss_threshold': $( if [ ! -z ${VIASH_PAR_TSS_THRESHOLD+x} ]; then echo "float(r'${VIASH_PAR_TSS_THRESHOLD//\\'/\\'\\"\\'\\"r\\'}')"; else echo None; fi ),
...
meta["defaults"] = [
  ...
  "container" : {
    "registry" : "ghcr.io",
    "image" : "openpipelines-bio/openpipeline/qc/calculate_atac_qc_metrics",
