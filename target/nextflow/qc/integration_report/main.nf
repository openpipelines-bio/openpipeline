// integration_report integration_build
// 
...
meta = [
  ...
  "functionality" : {
    ...
    "resources" : [
      {
        ...
        "path" : "script.py",
        "is_executable" : true,
        "parent" : "file:/home/runner/work/openpipeline/openpipeline/src/qc/integration_report/"
      },
      {
        "type" : "file",
    ...
    "description" : "Generates a .md file containing an overview of integration metrics (calculated in qc/integration_metrics) and umap visualizations.\n  \n",
    "test_resources" : [
      {
        "type" : "file",
...
meta["defaults"] = [
  ...
  "container" : {
    "registry" : "ghcr.io",
    "image" : "openpipelines-bio/qc/integration_report",
