// clear_slots qc-workflow-with-quantile-filtering_build
// 
...
meta = [
  ...
  "argument_groups" : [
    {
      ...
      "arguments" : [
        ...
        },
        {
          "type" : "string",
          "name" : "--slots",
          "description" : "Names of the AnnData slot families to clear from the selected modality.\n",
          "required" : true,
          "choices" : [
            "obsm",
            "varm",
  ...
  "build_info" : {
    "config" : "/home/runner/work/openpipeline/openpipeline/src/transform/clear_slots/config.vsh.yaml",
    "runner" : "nextflow",
    "engine" : "docker",
    "output" : "/home/runner/work/openpipeline/openpipeline/target/nextflow/transform/clear_slots",
    "viash_version" : "0.9.7",
...
par = {
  ...
  'slots': $( if [ ! -z ${VIASH_PAR_SLOTS+x} ]; then echo "r'${VIASH_PAR_SLOTS//\\'/\\'\\"\\'\\"r\\'}'.split(';')"; else echo None; fi ),
...
meta["defaults"] = [
  ...
  "container" : {
    "registry" : "ghcr.io",
    "image" : "openpipelines-bio/openpipeline/transform/clear_slots",
