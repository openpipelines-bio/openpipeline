  ...
  "resources" : [
    {
      ...
      "path" : "script.py",
      "is_executable" : true,
      "parent" : "file:/home/runner/work/openpipeline/openpipeline/src/transform/delete_layer/config.vsh.yaml"
    }
  ],
...
par = {
  ...
  'layer': $( if [ ! -z ${VIASH_PAR_LAYER+x} ]; then echo "'${VIASH_PAR_LAYER//\\'/\\\\\\'}'.split(':')"; else echo None; fi ),
  'output': $( if [ ! -z ${VIASH_PAR_OUTPUT+x} ]; then echo "'${VIASH_PAR_OUTPUT//\\'/\\\\\\'}'"; else echo None; fi ),
  'missing_ok': $( if [ ! -z ${VIASH_PAR_MISSING_OK+x} ]; then echo "'${VIASH_PAR_MISSING_OK//\\'/\\\\\\'}'.lower() == 'true'"; else echo None; fi )
}
meta = {
