...
$( if [ ! -z ${VIASH_PAR_SAMPLE_SHEET+x} ]; then echo "${VIASH_PAR_SAMPLE_SHEET}" | sed "s#'#'\\"'\\"'#g" | sed "s#.*#par_sample_sheet='&'#" ; fi )
$( if [ ! -z ${VIASH_PAR_OUTPUT+x} ]; then echo "${VIASH_PAR_OUTPUT}" | sed "s#'#'\\"'\\"'#g" | sed "s#.*#par_output='&'#" ; fi )
$( if [ ! -z ${VIASH_PAR_SEPARATE_REPORTS+x} ]; then echo "${VIASH_PAR_SEPARATE_REPORTS}" | sed "s#'#'\\"'\\"'#g" | sed "s#.*#par_separate_reports='&'#" ; fi )
$( if [ ! -z ${VIASH_PAR_REPORTS+x} ]; then echo "${VIASH_PAR_REPORTS}" | sed "s#'#'\\"'\\"'#g" | sed "s#.*#par_reports='&'#" ; fi )
$( if [ ! -z ${VIASH_PAR_CORES+x} ]; then echo "${VIASH_PAR_CORES}" | sed "s#'#'\\"'\\"'#g" | sed "s#.*#par_cores='&'#" ; fi )
$( if [ ! -z ${VIASH_PAR_MEMORY+x} ]; then echo "${VIASH_PAR_MEMORY}" | sed "s#'#'\\"'\\"'#g" | sed "s#.*#par_memory='&'#" ; fi )
