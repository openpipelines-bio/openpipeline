// bcl2fastq qc-workflow-with-quantile-filtering_build
// 
  ...
  "argument_groups" : [
    {
      ...
      "arguments" : [
        ...
        },
        {
          "type" : "boolean_true",
          "name" : "--ignore_missing",
          "description" : "Interpret missing *.bcl files as no call (N), interpret missing control files as not-set\ncontrol bits and fill in with zeros when *.stats files are missing.\n",
          "direction" : "input"
        }
      ]
    }
...
meta["defaults"] = [
  ...
  "container" : {
    "registry" : "ghcr.io",
    "image" : "openpipelines-bio/openpipeline/demux/bcl2fastq",
