...
thisHelpMessage = '''split_modalities main_build

Split the modalities from a single .h5mu multimodal sample into seperate .h5mu
files.
...
thisDefaultProcessArgs = [
  ...
  "container" : {
    "registry" : "ghcr.io",
    "image" : "openpipelines-bio/split_split_modalities",
    "tag" : "main_build"
  }
}"""),
  // auto settings
