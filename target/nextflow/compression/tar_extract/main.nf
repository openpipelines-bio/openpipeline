// tar_extract qc-workflow-with-quantile-filtering_build
// 
...
meta = [
  ...
  "build_info" : {
    "config" : "/home/runner/work/openpipeline/openpipeline/src/compression/tar_extract/config.vsh.yaml",
    "runner" : "nextflow",
    "engine" : "docker",
...
$( if [ ! -z ${VIASH_PAR_STRIP_COMPONENTS+x} ]; then echo "${VIASH_PAR_STRIP_COMPONENTS}" | sed "s#'#'\\"'\\"'#g;s#.*#par_strip_components='&'#" ; else echo "# par_strip_components="; fi )
...
meta["defaults"] = [
  ...
  "container" : {
    "registry" : "ghcr.io",
    "image" : "openpipelines-bio/openpipeline/compression/tar_extract",
