...
thisConfig = processConfig(jsonSlurper.parseText('''{
    ...
    "resources" : [
      {
        ...
        "path" : "script.R",
        "is_executable" : true,
        "parent" : "file:/home/di/code/openpipeline/src/process_10xh5/filter_10xh5/config.vsh.yaml"
      }
    ],
  ...
  "info" : {
    "config" : "/home/di/code/openpipeline/src/process_10xh5/filter_10xh5/config.vsh.yaml",
    "platform" : "nextflow",
    "viash_version" : "0.7.1",
