  ...
  "resources" : [
    {
      ...
      "path" : "./script.py",
      "is_executable" : true,
      "parent" : "file:/home/runner/work/openpipeline/openpipeline/src/graph/bbknn/config.vsh.yaml"
    }
  ],
...
par = {
  ...
  'n_neighbours_within_batch': $( if [ ! -z ${VIASH_PAR_N_NEIGHBOURS_WITHIN_BATCH+x} ]; then echo "int('${VIASH_PAR_N_NEIGHBOURS_WITHIN_BATCH//\\'/\\\\\\'}')"; else echo None; fi ),
  'obs_batch': $( if [ ! -z ${VIASH_PAR_OBS_BATCH+x} ]; then echo "'${VIASH_PAR_OBS_BATCH//\\'/\\\\\\'}'"; else echo None; fi ),
  'n_pcs': $( if [ ! -z ${VIASH_PAR_N_PCS+x} ]; then echo "int('${VIASH_PAR_N_PCS//\\'/\\\\\\'}')"; else echo None; fi ),
  'n_trim': $( if [ ! -z ${VIASH_PAR_N_TRIM+x} ]; then echo "int('${VIASH_PAR_N_TRIM//\\'/\\\\\\'}')"; else echo None; fi ),
  'obm_representation': $( if [ ! -z ${VIASH_PAR_OBM_REPRESENTATION+x} ]; then echo "'${VIASH_PAR_OBM_REPRESENTATION//\\'/\\\\\\'}'"; else echo None; fi )
}
meta = {
...
thisDefaultProcessArgs = [
  ...
  "container" : {
    "registry" : "ghcr.io",
    "image" : "openpipelines-bio/graph_bbknn",
    "tag" : "main_build"
  },
  "label" : [
    "highmem"
