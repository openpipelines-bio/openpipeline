// score_genes_cell_cycle_scanpy qc-workflow-with-quantile-filtering_build
// 
...
meta = [
    ...
    },
    {
      ...
      "arguments" : [
        ...
        },
        {
          "type" : "string",
          "name" : "--gene_pool",
          "description" : "List of gene symbols for sampling the reference set. Default is all genes.\n",
          "example" : [
            "gene1",
            "gene2",
            "gene3"
  ...
  "build_info" : {
    "config" : "/home/runner/work/openpipeline/openpipeline/src/feature_annotation/score_genes_cell_cycle_scanpy/config.vsh.yaml",
    "runner" : "nextflow",
    "engine" : "docker",
...
meta["defaults"] = [
  ...
  "container" : {
    "registry" : "ghcr.io",
    "image" : "openpipelines-bio/openpipeline/feature_annotation/score_genes_cell_cycle_scanpy",
