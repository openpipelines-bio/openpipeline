// annotation annotation-workflow_build
// 
        ...
        "arguments" : [
          {
            ...
            "example" : [
              "resources_test/scgpt/test_resources/Kim2020_Lung_preprocessed.h5mu"
            ],
            "must_exist" : true,
            "create_parent" : true,
            "required" : true,
          ...
          },
          {
            ...
            "description" : "The name of the adata.obs column containing the batch labels. Required if dsbn is set to true.\n",
            "required" : false,
            "direction" : "input",
            "multiple" : false,
            "multiple_sep" : ":",
        ...
        "arguments" : [
          {
            ...
            "example" : [
              "Kim2020_Lung_cell_type_annotation.h5mu"
            ],
            "must_exist" : true,
            "create_parent" : true,
            "required" : true,
      ...
      },
      {
        ...
        "arguments" : [
          ...
          },
          {
            "type" : "integer",
            "name" : "--seed",
            "description" : "Seed for random number generation. If not specified, no seed is used.\n",
            "required" : false,
            "direction" : "input",
            "multiple" : false,
            "multiple_sep" : ":",
    ...
    "resources" : [
      {
        ...
        "path" : "script.py",
        "is_executable" : true,
        "parent" : "file:/home/runner/work/openpipeline/openpipeline/src/scgpt/annotation/"
      },
      {
        "type" : "file",
...
par = {
  ...
  'label_mapper_key': $( if [ ! -z ${VIASH_PAR_LABEL_MAPPER_KEY+x} ]; then echo "r'${VIASH_PAR_LABEL_MAPPER_KEY//\\'/\\'\\"\\'\\"r\\'}'"; else echo None; fi ),
