// embedding scgpt-preprocessor_build
// 
...
meta = [
  ...
  "functionality" : {
        ...
        "arguments" : [
          {
            "type" : "file",
            "name" : "--input",
            "description" : "The input h5mu file containing preprocessed data. \n",
            "example" : [
              "input.h5mu"
            ],
            "must_exist" : true,
    ...
    "description" : "Embedding of a batch of tokenized data for scGPT zero-shot or fine-tuning integration.\n",
    "test_resources" : [
      {
        "type" : "python_script",
        "path" : "test.py",
