...
meta = [
    ...
    "argument_groups" : [
      {
        ...
        "arguments" : [
          ...
          },
          {
            "type" : "file",
            "name" : "--model_dir",
            "description" : "The directory containing the model files. Must contain 'vocab.json', 'model.pt' and 'args.json' files.\n",
            "example" : [
          ...
          },
          {
            "type" : "string",
            "name" : "--input_layer",
            "description" : "The key in the mudata layer to use as raw data.\n",
            "default" : [
              "X"
            ],
            "required" : false,
          ...
          },
          {
            ...
            "description" : "The column in the adata.obs that contains the batch information.\n",
            "default" : [
              "sample"
            ],
            "required" : false,
          ...
          },
          {
            ...
            "description" : "The name of adata.var column containing the gene names.\n",
            "default" : [
              "gene_name"
            ],
            "required" : false,
        ...
        "arguments" : [
          {
            "type" : "file",
            "name" : "--output",
            "description" : "The output h5mu file containing the preprocessed data.    \n",
            "example" : [
              "output.h5mu"
            ],
            "must_exist" : true,
          ...
          },
          {
            "type" : "string",
            "name" : "--batch_id_layer",
            "description" : "The name of the adata.obs column to write categorical batch ids to.\n",
            "default" : [
              "batch_id"
            ],
            "required" : false,
          ...
          },
          {
            ...
            "description" : "The name of the adata layer to write the normalized total counts to.\n",
            "default" : [
              "X_normed"
            ],
            "required" : false,
          ...
          },
          {
            "type" : "string",
            "name" : "--log1p_layer",
            "description" : "The name of the adata layer to write the log1p transformed data to. Will only be written if 'data_is_raw' flag is set to true.\n",
            "default" : [
              "X_log1p"
            ],
            "required" : false,
      ...
      },
      {
        ...
        "arguments" : [
          ...
          },
          {
            ...
            "description" : "Number of counts to filter genes by. Set to -1 if no gene count filtering should be performed.\n",
            "default" : [
              3
            ],
            "required" : false,
          ...
          },
          {
            ...
            "description" : "Number of counts to filter cells by. Set to -1 if no cell count filtering should be performed.\n",
            "default" : [
              -1
            ],
            "required" : false,
          ...
          },
          {
            "type" : "integer",
            "name" : "--n_hvg",
            "description" : "The number of highly variable genes to be subset for tokenization. Set to -1 if no hvg subsetting should be performed.\n",
            "default" : [
              1200
            ],
            "required" : false,
          ...
          },
          {
            ...
            "description" : "The total counts to normalize the data to. Set to -1 if no normalization should be performed.\n",
            "default" : [
              10000
            ],
            "required" : false,
          ...
          },
          {
            "type" : "boolean",
            "name" : "--data_is_raw",
            "description" : "Whether the input data is raw and needs to be log1p transformed.\n",
            "default" : [
              true
            ],
            "required" : false,
          ...
          },
          {
            "type" : "integer",
            "name" : "--n_input_bins",
            "description" : "The number of bins to discretize the input data into.\n",
            "default" : [
              51
            ],
            "required" : false,
    ...
    "resources" : [
      {
        ...
        "path" : "script.py",
        "is_executable" : true,
        "parent" : "file:/home/runner/work/openpipeline/openpipeline/src/scgpt/integration/preprocessing/"
      },
      {
        "type" : "file",
  ...
  "info" : {
    "config" : "/home/runner/work/openpipeline/openpipeline/src/scgpt/integration/preprocessing/config.vsh.yaml",
    "platform" : "nextflow",
    "output" : "/home/runner/work/openpipeline/openpipeline/target/nextflow/scgpt/integration_preprocessing",
    "viash_version" : "0.8.5",
...
meta["defaults"] = [
  ...
  "container" : {
    "registry" : "ghcr.io",
    "image" : "openpipelines-bio/scgpt_integration_preprocessing",
