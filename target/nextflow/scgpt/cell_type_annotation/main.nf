// cell_type_annotation integration_build
// 
      ...
      },
      {
        ...
        "arguments" : [
          ...
          },
          {
            "type" : "integer",
            "name" : "--n_cls",
            "description" : "The number of cell type classes to predict.\n",
            "default" : [
              8
            ],
            "required" : false,
    ...
    "resources" : [
      {
        ...
        "path" : "script.py",
        "is_executable" : true,
        "parent" : "file:/home/runner/work/openpipeline/openpipeline/src/scgpt/cell_type_annotation/"
      },
      {
        "type" : "file",
...
par = {
  ...
  'obs_predicted_cell_type': $( if [ ! -z ${VIASH_PAR_OBS_PREDICTED_CELL_TYPE+x} ]; then echo "r'${VIASH_PAR_OBS_PREDICTED_CELL_TYPE//\\'/\\'\\"\\'\\"r\\'}'"; else echo None; fi ),
  ...
  'n_cls': $( if [ ! -z ${VIASH_PAR_N_CLS+x} ]; then echo "int(r'${VIASH_PAR_N_CLS//\\'/\\'\\"\\'\\"r\\'}')"; else echo None; fi ),
...
meta["defaults"] = [
  ...
  "container" : {
    "registry" : "ghcr.io",
    "image" : "openpipelines-bio/scgpt/cell_type_annotation",
