// integration_embedding embed_build
// 
    ...
    "argument_groups" : [
      {
        ...
        "arguments" : [
          ...
          },
          {
            "type" : "file",
            "name" : "--input_values",
            "description" : "Path to pytorch tensor file containing the tokenized and padded values.\n",
            "example" : [
              "values.pt"
            ],
            "must_exist" : true,
    ...
    "resources" : [
      {
        ...
        "path" : "script.py",
        "is_executable" : true,
        "parent" : "file:/home/runner/work/openpipeline/openpipeline/src/scgpt/integration_embedding/"
      },
      {
        "type" : "file",
...
par = {
  ...
  'load_model_configs': $( if [ ! -z ${VIASH_PAR_LOAD_MODEL_CONFIGS+x} ]; then echo "r'${VIASH_PAR_LOAD_MODEL_CONFIGS//\\'/\\'\\"\\'\\"r\\'}'.lower() == 'true'"; else echo None; fi ),
  'layer_size': $( if [ ! -z ${VIASH_PAR_LAYER_SIZE+x} ]; then echo "int(r'${VIASH_PAR_LAYER_SIZE//\\'/\\'\\"\\'\\"r\\'}')"; else echo None; fi ),
  'nhead': $( if [ ! -z ${VIASH_PAR_NHEAD+x} ]; then echo "int(r'${VIASH_PAR_NHEAD//\\'/\\'\\"\\'\\"r\\'}')"; else echo None; fi ),
  'nlayers': $( if [ ! -z ${VIASH_PAR_NLAYERS+x} ]; then echo "int(r'${VIASH_PAR_NLAYERS//\\'/\\'\\"\\'\\"r\\'}')"; else echo None; fi ),
  ...
  'GEPC': $( if [ ! -z ${VIASH_PAR_GEPC+x} ]; then echo "r'${VIASH_PAR_GEPC//\\'/\\'\\"\\'\\"r\\'}'.lower() == 'true'"; else echo None; fi ),
  'n_input_bins': $( if [ ! -z ${VIASH_PAR_N_INPUT_BINS+x} ]; then echo "int(r'${VIASH_PAR_N_INPUT_BINS//\\'/\\'\\"\\'\\"r\\'}')"; else echo None; fi ),
  'ecs_threshold': $( if [ ! -z ${VIASH_PAR_ECS_THRESHOLD+x} ]; then echo "float(r'${VIASH_PAR_ECS_THRESHOLD//\\'/\\'\\"\\'\\"r\\'}')"; else echo None; fi ),
  'explicit_zero_prob': $( if [ ! -z ${VIASH_PAR_EXPLICIT_ZERO_PROB+x} ]; then echo "r'${VIASH_PAR_EXPLICIT_ZERO_PROB//\\'/\\'\\"\\'\\"r\\'}'.lower() == 'true'"; else echo None; fi ),
  'use_fast_transformer': $( if [ ! -z ${VIASH_PAR_USE_FAST_TRANSFORMER+x} ]; then echo "r'${VIASH_PAR_USE_FAST_TRANSFORMER//\\'/\\'\\"\\'\\"r\\'}'.lower() == 'true'"; else echo None; fi ),
  'pre_norm': $( if [ ! -z ${VIASH_PAR_PRE_NORM+x} ]; then echo "r'${VIASH_PAR_PRE_NORM//\\'/\\'\\"\\'\\"r\\'}'.lower() == 'true'"; else echo None; fi ),
