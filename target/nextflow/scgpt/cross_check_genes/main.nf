// cross_check_genes update_viash_actions_for_github_build
// 
        ...
        "arguments" : [
          {
            "type" : "file",
            "name" : "--output",
            "description" : "The output cross-checked anndata file.\n",
            "example" : [
              "output.h5mu"
            ],
            "must_exist" : true,
    ...
    "resources" : [
      {
        ...
        "path" : "script.py",
        "is_executable" : true,
        "parent" : "file:/home/runner/work/openpipeline/openpipeline/src/scgpt/cross_check_genes/"
      },
      {
        "type" : "file",
