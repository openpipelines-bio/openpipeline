...
par <- list(
  "base_dir" = $( if [ ! -z ${VIASH_PAR_BASE_DIR+x} ]; then echo "paste0(r'(${VIASH_PAR_BASE_DIR//\\'/)\\', \\"\\'\\", r\\'(})')"; else echo NULL; fi ),
  "pattern" = $( if [ ! -z ${VIASH_PAR_PATTERN+x} ]; then echo "paste0(r'(${VIASH_PAR_PATTERN//\\'/)\\', \\"\\'\\", r\\'(})')"; else echo NULL; fi ),
  "n_dirname_drop" = $( if [ ! -z ${VIASH_PAR_N_DIRNAME_DROP+x} ]; then echo "as.integer(paste0(r'(${VIASH_PAR_N_DIRNAME_DROP//\\'/)\\', \\"\\'\\", r\\'(})'))"; else echo NULL; fi ),
  "n_basename_id" = $( if [ ! -z ${VIASH_PAR_N_BASENAME_ID+x} ]; then echo "as.integer(paste0(r'(${VIASH_PAR_N_BASENAME_ID//\\'/)\\', \\"\\'\\", r\\'(})'))"; else echo NULL; fi ),
  "id_name" = $( if [ ! -z ${VIASH_PAR_ID_NAME+x} ]; then echo "paste0(r'(${VIASH_PAR_ID_NAME//\\'/)\\', \\"\\'\\", r\\'(})')"; else echo NULL; fi ),
  "path_name" = $( if [ ! -z ${VIASH_PAR_PATH_NAME+x} ]; then echo "paste0(r'(${VIASH_PAR_PATH_NAME//\\'/)\\', \\"\\'\\", r\\'(})')"; else echo NULL; fi ),
  "group_name" = $( if [ ! -z ${VIASH_PAR_GROUP_NAME+x} ]; then echo "paste0(r'(${VIASH_PAR_GROUP_NAME//\\'/)\\', \\"\\'\\", r\\'(})')"; else echo NULL; fi ),
