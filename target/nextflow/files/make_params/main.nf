...
//  * Robrecht Cannoodt <rcannood@gmail.com> (maintainer, author) {github:
...
par <- list(
  "base_dir" = $( if [ ! -z ${VIASH_PAR_BASE_DIR+x} ]; then echo "'${VIASH_PAR_BASE_DIR//\\'/\\\\\\'}'"; else echo NULL; fi ),
  "pattern" = $( if [ ! -z ${VIASH_PAR_PATTERN+x} ]; then echo "'${VIASH_PAR_PATTERN//\\'/\\\\\\'}'"; else echo NULL; fi ),
  "n_dirname_drop" = $( if [ ! -z ${VIASH_PAR_N_DIRNAME_DROP+x} ]; then echo "as.integer('${VIASH_PAR_N_DIRNAME_DROP//\\'/\\\\\\'}')"; else echo NULL; fi ),
