// filter_with_pattern qc-workflow-with-quantile-filtering_build
// 
...
meta = [
  ...
  "argument_groups" : [
    {
      ...
      "arguments" : [
        ...
        },
        {
          "type" : "string",
          "name" : "--var_gene_names",
          "description" : "The .var field containing the gene names to be filtered. If not provided, `.var.index` will be used.\n",
          "example" : [
            "gene_symbol"
          ],
          "required" : false,
  ...
  "build_info" : {
    "config" : "/home/runner/work/openpipeline/openpipeline/src/filter/filter_with_pattern/config.vsh.yaml",
    "runner" : "nextflow",
    "engine" : "docker",
...
par = {
  ...
  'pattern': $( if [ ! -z ${VIASH_PAR_PATTERN+x} ]; then echo "r'${VIASH_PAR_PATTERN//\\'/\\'\\"\\'\\"r\\'}'.split(';')"; else echo None; fi ),
...
meta["defaults"] = [
  ...
  "container" : {
    "registry" : "ghcr.io",
    "image" : "openpipelines-bio/openpipeline/filter/filter_with_pattern",
