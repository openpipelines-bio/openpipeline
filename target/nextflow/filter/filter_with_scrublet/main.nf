...
thisHelpMessage = '''filter_with_scrublet 0.3.1
...
observations should be filtered out.
    ...
    --obs_name_doublet_score
        type: string
        default: scrublet_doublet_score
        Name of the doublet scores column in the obs slot of the returned
object.

    --min_counts
        type: integer
        default: 2
        The number of minimal UMI counts per cell that have to be present for
initial cell detection.
    ...
    --min_gene_variablity_percent
        type: double
        default: 85.0
        Used for gene filtering prior to PCA. Keep the most highly variable
...
v-statistic [Klein et al., Cell 2015].
    ...
    --num_pca_components
        type: integer
        default: 30
        Number of principal components to use during PCA dimensionality
reduction.
