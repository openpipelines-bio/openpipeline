// subset_obsp qc-workflow-with-quantile-filtering_build
// 
...
meta = [
  ...
  "description" : "Create a subset of an .obsp field in a mudata file, by filtering the columns based on the values of an .obs column. The resulting subset is moved to an .obsm slot.\n",
  "test_resources" : [
    {
      "type" : "python_script",
      "path" : "test.py",
  ...
  "build_info" : {
    "config" : "/home/runner/work/openpipeline/openpipeline/src/filter/subset_obsp/config.vsh.yaml",
    "runner" : "nextflow",
    "engine" : "docker",
...
par = {
  ...
  'input_obsp_key': $( if [ ! -z ${VIASH_PAR_INPUT_OBSP_KEY+x} ]; then echo "r'${VIASH_PAR_INPUT_OBSP_KEY//\\'/\\'\\"\\'\\"r\\'}'"; else echo None; fi ),
  'input_obs_key': $( if [ ! -z ${VIASH_PAR_INPUT_OBS_KEY+x} ]; then echo "r'${VIASH_PAR_INPUT_OBS_KEY//\\'/\\'\\"\\'\\"r\\'}'"; else echo None; fi ),
  'input_obs_value': $( if [ ! -z ${VIASH_PAR_INPUT_OBS_VALUE+x} ]; then echo "r'${VIASH_PAR_INPUT_OBS_VALUE//\\'/\\'\\"\\'\\"r\\'}'"; else echo None; fi ),
  'output': $( if [ ! -z ${VIASH_PAR_OUTPUT+x} ]; then echo "r'${VIASH_PAR_OUTPUT//\\'/\\'\\"\\'\\"r\\'}'"; else echo None; fi ),
  'output_obsm_key': $( if [ ! -z ${VIASH_PAR_OUTPUT_OBSM_KEY+x} ]; then echo "r'${VIASH_PAR_OUTPUT_OBSM_KEY//\\'/\\'\\"\\'\\"r\\'}'"; else echo None; fi )
}
meta = {
...
meta["defaults"] = [
  ...
  "container" : {
    "registry" : "ghcr.io",
    "image" : "openpipelines-bio/openpipeline/filter/subset_obsp",
