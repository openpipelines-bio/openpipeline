// create_cell_masks integration_build
// 
...
meta = [
      ...
      "arguments" : [
        {
          "type" : "string",
          "name" : "--modality",
          "summary" : "The name of the modality to use from the MuData object\n",
  ...
  "description" : "Create boolean cell masks using a set of provided filters. These masks are\nstored so that they can be used to select cells in later stages.\n",
  "test_resources" : [
    {
      "type" : "python_script",
      "path" : "test.py",
  ...
  "build_info" : {
    "config" : "/home/runner/work/openpipeline/openpipeline/src/filter/create_cell_masks/config.vsh.yaml",
    "runner" : "nextflow",
    "engine" : "docker",
    "output" : "/home/runner/work/openpipeline/openpipeline/target/nextflow/filter/create_cell_masks",
    "viash_version" : "0.9.7",
...
par = {
  ...
  'filters': $( if [ ! -z ${VIASH_PAR_FILTERS+x} ]; then echo "r'${VIASH_PAR_FILTERS//\\'/\\'\\"\\'\\"r\\'}'.split(';')"; else echo None; fi ),
  'prefix': $( if [ ! -z ${VIASH_PAR_PREFIX+x} ]; then echo "r'${VIASH_PAR_PREFIX//\\'/\\'\\"\\'\\"r\\'}'"; else echo None; fi )
}
meta = {
...
meta["defaults"] = [
  ...
  "container" : {
    "registry" : "ghcr.io",
    "image" : "openpipelines-bio/openpipeline/filter/create_cell_masks",
