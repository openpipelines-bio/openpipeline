// differential_expression integration_build
// 
...
meta = [
  ...
  "build_info" : {
    "config" : "/home/runner/work/openpipeline/openpipeline/src/differential_expression/create_pseudobulk/config.vsh.yaml",
    "runner" : "nextflow",
    "engine" : "docker",
    "output" : "/home/runner/work/openpipeline/openpipeline/target/nextflow/create_pseudobulk/differential_expression",
    "viash_version" : "0.9.4",
...
par = {
  ...
  'obs_groups': $( if [ ! -z ${VIASH_PAR_OBS_GROUPS+x} ]; then echo "r'${VIASH_PAR_OBS_GROUPS//\\'/\\'\\"\\'\\"r\\'}'.split(';')"; else echo None; fi ),
  'aggregation_method': $( if [ ! -z ${VIASH_PAR_AGGREGATION_METHOD+x} ]; then echo "r'${VIASH_PAR_AGGREGATION_METHOD//\\'/\\'\\"\\'\\"r\\'}'"; else echo None; fi ),
  'min_obs_per_sample': $( if [ ! -z ${VIASH_PAR_MIN_OBS_PER_SAMPLE+x} ]; then echo "int(r'${VIASH_PAR_MIN_OBS_PER_SAMPLE//\\'/\\'\\"\\'\\"r\\'}')"; else echo None; fi ),
  'random_state': $( if [ ! -z ${VIASH_PAR_RANDOM_STATE+x} ]; then echo "int(r'${VIASH_PAR_RANDOM_STATE//\\'/\\'\\"\\'\\"r\\'}')"; else echo None; fi ),
  'obs_cell_count': $( if [ ! -z ${VIASH_PAR_OBS_CELL_COUNT+x} ]; then echo "r'${VIASH_PAR_OBS_CELL_COUNT//\\'/\\'\\"\\'\\"r\\'}'"; else echo None; fi ),
...
meta["defaults"] = [
  ...
  "container" : {
    "registry" : "ghcr.io",
    "image" : "openpipelines-bio/openpipeline/create_pseudobulk/differential_expression",
