...
thisHelpMessage = '''leiden main_build

Cluster cells using the Leiden algorithm [Traag18] implemented in the Scanpy
framework [Wolf18]. Leiden is an improved version of the Louvain algorithm
[Blondel08].
...
Blondel et al. (2008), Fast unfolding of communities in large networks, J. Stat.
Mech.
...
Traag et al. (2018), From Louvain to Leiden: guaranteeing well-connected
communities arXiv.
