...
// 
// Component authors:
//  * Vladimir Shitov <vladimir.shitov@helmholtz-muenchen.de> {github:
// vladimirshitov, orcid: 0000-0002-1960-8812}
...
thisConfig = processConfig(jsonSlurper.parseText('''{
    ...
    "resources" : [
      {
        ...
        "path" : "script.py",
        "is_executable" : true,
        "parent" : "file:/home/di/code/openpipeline/src/integrate/scarches/config.vsh.yaml"
      }
    ],
  ...
  "info" : {
    "config" : "/home/di/code/openpipeline/src/integrate/scarches/config.vsh.yaml",
    "platform" : "nextflow",
    "viash_version" : "0.7.1",
