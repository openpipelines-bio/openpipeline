  ...
  "resources" : [
    {
      ...
      "path" : "script.R",
      "is_executable" : true,
      "parent" : "file:/home/runner/work/openpipeline/openpipeline/src/integrate/harmony/config.vsh.yaml"
    }
  ],
...
par <- list(
  ...
  "modality" = $( if [ ! -z ${VIASH_PAR_MODALITY+x} ]; then echo "paste0(r'(${VIASH_PAR_MODALITY//\\'/)\\', \\"\\'\\", r\\'(})')"; else echo NULL; fi ),
  "obsm_input" = $( if [ ! -z ${VIASH_PAR_OBSM_INPUT+x} ]; then echo "paste0(r'(${VIASH_PAR_OBSM_INPUT//\\'/)\\', \\"\\'\\", r\\'(})')"; else echo NULL; fi ),
  "obsm_output" = $( if [ ! -z ${VIASH_PAR_OBSM_OUTPUT+x} ]; then echo "paste0(r'(${VIASH_PAR_OBSM_OUTPUT//\\'/)\\', \\"\\'\\", r\\'(})')"; else echo NULL; fi ),
  "theta" = $( if [ ! -z ${VIASH_PAR_THETA+x} ]; then echo "as.numeric(strsplit(paste0(r'(${VIASH_PAR_THETA//\\'/)\\', \\"\\'\\", r\\'(})'), split = ':')[[1]])"; else echo NULL; fi ),
  "obs_covariates" = $( if [ ! -z ${VIASH_PAR_OBS_COVARIATES+x} ]; then echo "strsplit(paste0(r'(${VIASH_PAR_OBS_COVARIATES//\\'/)\\', \\"\\'\\", r\\'(})'), split = ':')[[1]]"; else echo NULL; fi )
)
meta <- list(
...
thisDefaultProcessArgs = [
  ...
  "container" : {
    "registry" : "ghcr.io",
    "image" : "openpipelines-bio/integrate_harmony",
