  ...
  "argument_groups" : [
    {
      ...
      "arguments" : [
        ...
        },
        {
          "type" : "string",
          "name" : "--obs_key",
          "description" : "Obs column name where the sample id can be found for each observation to join on. Usefull when adding metadata to concatenated samples. Mutually exclusive with --var_key and --sample_id",
          "required" : false,
          "direction" : "input",
          "multiple" : false,
          "multiple_sep" : ":",
        ...
        },
        {
          "type" : "string",
          "name" : "--var_key",
          "description" : "Var column name where the sample id can be found for each observation to join on. Usefull when adding metadata to concatenated samples. Mutually exclusive with --var_key and --sample_id.",
          "required" : false,
          "direction" : "input",
          "multiple" : false,
          "multiple_sep" : ":",
  ...
  "resources" : [
    {
      ...
      "path" : "script.py",
      "is_executable" : true,
      "parent" : "file:/home/runner/work/openpipeline/openpipeline/src/integrate/add_metadata/config.vsh.yml"
    }
  ],
...
par = {
  ...
  'obs_key': $( if [ ! -z ${VIASH_PAR_OBS_KEY+x} ]; then echo "'${VIASH_PAR_OBS_KEY//\\'/\\\\\\'}'"; else echo None; fi ),
  'var_key': $( if [ ! -z ${VIASH_PAR_VAR_KEY+x} ]; then echo "'${VIASH_PAR_VAR_KEY//\\'/\\\\\\'}'"; else echo None; fi ),
  'output': $( if [ ! -z ${VIASH_PAR_OUTPUT+x} ]; then echo "'${VIASH_PAR_OUTPUT//\\'/\\\\\\'}'"; else echo None; fi ),
  'input_csv': $( if [ ! -z ${VIASH_PAR_INPUT_CSV+x} ]; then echo "'${VIASH_PAR_INPUT_CSV//\\'/\\\\\\'}'"; else echo None; fi ),
  'csv_key': $( if [ ! -z ${VIASH_PAR_CSV_KEY+x} ]; then echo "'${VIASH_PAR_CSV_KEY//\\'/\\\\\\'}'"; else echo None; fi )
}
meta = {
...
thisDefaultProcessArgs = [
  ...
  "container" : {
    "registry" : "ghcr.io",
    "image" : "openpipelines-bio/integrate_add_metadata",
    "tag" : "main_build"
  }
}'''),
  // auto settings
