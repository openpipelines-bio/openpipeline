  ...
  "resources" : [
    {
      ...
      "path" : "./script.py",
      "is_executable" : true,
      "parent" : "file:/home/runner/work/openpipeline/openpipeline/src/integrate/scanorama/config.vsh.yaml"
    }
  ],
...
par = {
  ...
  'knn': $( if [ ! -z ${VIASH_PAR_KNN+x} ]; then echo "int('${VIASH_PAR_KNN//\\'/\\\\\\'}')"; else echo None; fi ),
  'batch_size': $( if [ ! -z ${VIASH_PAR_BATCH_SIZE+x} ]; then echo "int('${VIASH_PAR_BATCH_SIZE//\\'/\\\\\\'}')"; else echo None; fi ),
  'sigma': $( if [ ! -z ${VIASH_PAR_SIGMA+x} ]; then echo "float('${VIASH_PAR_SIGMA//\\'/\\\\\\'}')"; else echo None; fi ),
  'approx': $( if [ ! -z ${VIASH_PAR_APPROX+x} ]; then echo "'${VIASH_PAR_APPROX//\\'/\\\\\\'}'.lower() == 'true'"; else echo None; fi ),
