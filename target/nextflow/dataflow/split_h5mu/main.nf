...
meta = [
    ...
    "resources" : [
      {
        ...
        "path" : "script.py",
        "is_executable" : true,
        "parent" : "file:/home/runner/work/openpipeline/openpipeline/src/dataflow/split_h5mu/"
      },
      {
        "type" : "file",
  ...
  "info" : {
    "config" : "/home/runner/work/openpipeline/openpipeline/src/dataflow/split_h5mu/config.vsh.yaml",
    "platform" : "nextflow",
...
par = {
  ...
  'obs_feature': $( if [ ! -z ${VIASH_PAR_OBS_FEATURE+x} ]; then echo "r'${VIASH_PAR_OBS_FEATURE//\\'/\\'\\"\\'\\"r\\'}'"; else echo None; fi ),
  'drop_obs_nan': $( if [ ! -z ${VIASH_PAR_DROP_OBS_NAN+x} ]; then echo "r'${VIASH_PAR_DROP_OBS_NAN//\\'/\\'\\"\\'\\"r\\'}'.lower() == 'true'"; else echo None; fi ),
  'ensure_unique_filenames': $( if [ ! -z ${VIASH_PAR_ENSURE_UNIQUE_FILENAMES+x} ]; then echo "r'${VIASH_PAR_ENSURE_UNIQUE_FILENAMES//\\'/\\'\\"\\'\\"r\\'}'.lower() == 'true'"; else echo None; fi ),
  'output': $( if [ ! -z ${VIASH_PAR_OUTPUT+x} ]; then echo "r'${VIASH_PAR_OUTPUT//\\'/\\'\\"\\'\\"r\\'}'"; else echo None; fi ),
  'output_compression': $( if [ ! -z ${VIASH_PAR_OUTPUT_COMPRESSION+x} ]; then echo "r'${VIASH_PAR_OUTPUT_COMPRESSION//\\'/\\'\\"\\'\\"r\\'}'"; else echo None; fi ),
  'output_files': $( if [ ! -z ${VIASH_PAR_OUTPUT_FILES+x} ]; then echo "r'${VIASH_PAR_OUTPUT_FILES//\\'/\\'\\"\\'\\"r\\'}'"; else echo None; fi )
}
meta = {
...
meta["defaults"] = [
  ...
  "container" : {
    "registry" : "ghcr.io",
    "image" : "openpipelines-bio/dataflow/split_h5mu",
