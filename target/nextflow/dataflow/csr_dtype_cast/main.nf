// csr_dtype_cast dtype_csr_fix_build
// 
...
meta = [
  ...
  "description" : "Casts the dtypes of AnnData.layer.indptr and AnnData.layer.indices to scipy-compatible dtypes.\n    \n",
  "test_resources" : [
    {
      "type" : "python_script",
      "path" : "test.py",
  ...
  "build_info" : {
    "config" : "/home/runner/work/openpipeline/openpipeline/src/dataflow/csr_dtype_cast/config.vsh.yaml",
    "runner" : "nextflow",
    "engine" : "docker",
    "output" : "/home/runner/work/openpipeline/openpipeline/target/nextflow/dataflow/csr_dtype_cast",
    "viash_version" : "0.9.0",
...
par = {
  ...
  'dtype': $( if [ ! -z ${VIASH_PAR_DTYPE+x} ]; then echo "r'${VIASH_PAR_DTYPE//\\'/\\'\\"\\'\\"r\\'}'"; else echo None; fi ),
...
meta["defaults"] = [
  ...
  "container" : {
    "registry" : "ghcr.io",
    "image" : "openpipelines-bio/openpipeline/dataflow/csr_dtype_cast",
