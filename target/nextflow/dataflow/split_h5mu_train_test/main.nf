// split_h5mu_train_test integration_build
// 
...
meta = [
    ...
    "resources" : [
      {
        ...
        "path" : "script.py",
        "is_executable" : true,
        "parent" : "file:/home/runner/work/openpipeline/openpipeline/src/dataflow/split_h5mu_train_test/"
      },
      {
        "type" : "file",
  ...
  "info" : {
    "config" : "/home/runner/work/openpipeline/openpipeline/src/dataflow/split_h5mu_train_test/config.vsh.yaml",
    "platform" : "nextflow",
    "output" : "/home/runner/work/openpipeline/openpipeline/target/nextflow/dataflow/split_h5mu_train_test",
    "viash_version" : "0.8.6",
...
par = {
  ...
  'output_val': $( if [ ! -z ${VIASH_PAR_OUTPUT_VAL+x} ]; then echo "r'${VIASH_PAR_OUTPUT_VAL//\\'/\\'\\"\\'\\"r\\'}'"; else echo None; fi ),
  'compression': $( if [ ! -z ${VIASH_PAR_COMPRESSION+x} ]; then echo "r'${VIASH_PAR_COMPRESSION//\\'/\\'\\"\\'\\"r\\'}'"; else echo None; fi ),
  'test_size': $( if [ ! -z ${VIASH_PAR_TEST_SIZE+x} ]; then echo "float(r'${VIASH_PAR_TEST_SIZE//\\'/\\'\\"\\'\\"r\\'}')"; else echo None; fi ),
  'val_size': $( if [ ! -z ${VIASH_PAR_VAL_SIZE+x} ]; then echo "float(r'${VIASH_PAR_VAL_SIZE//\\'/\\'\\"\\'\\"r\\'}')"; else echo None; fi ),
  'shuffle': $( if [ ! -z ${VIASH_PAR_SHUFFLE+x} ]; then echo "r'${VIASH_PAR_SHUFFLE//\\'/\\'\\"\\'\\"r\\'}'.lower() == 'true'"; else echo None; fi ),
...
meta["defaults"] = [
  ...
  "container" : {
    "registry" : "ghcr.io",
    "image" : "openpipelines-bio/dataflow/split_h5mu_train_test",
