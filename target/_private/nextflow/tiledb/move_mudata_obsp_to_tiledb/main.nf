// move_mudata_obsp_to_tiledb qc-workflow-with-quantile-filtering_build
// 
...
meta = [
    ...
    },
    {
      ...
      "arguments" : [
        ...
        },
        {
          "type" : "string",
          "name" : "--modality",
          "description" : "Modality where to take the .obsp from.\n",
          "required" : true,
          "direction" : "input",
          "multiple" : false,
          "multiple_sep" : ";"
        },
        {
          "type" : "string",
          "name" : "--obsp_input",
          "description" : "Keys from .obsp to copy. The keys should not be present yet in the database.\n",
          "required" : false,
          "direction" : "input",
          "multiple" : true,
          "multiple_sep" : ";"
  ...
  "build_info" : {
    "config" : "/home/runner/work/openpipeline/openpipeline/src/tiledb/move_mudata_obsp_to_tiledb/config.vsh.yaml",
    "runner" : "nextflow",
    "engine" : "docker",
...
par = {
  ...
  'obsp_input': $( if [ ! -z ${VIASH_PAR_OBSP_INPUT+x} ]; then echo "r'${VIASH_PAR_OBSP_INPUT//\\'/\\'\\"\\'\\"r\\'}'.split(';')"; else echo None; fi ),
...
meta["defaults"] = [
  ...
  "container" : {
    "registry" : "ghcr.io",
    "image" : "openpipelines-bio/openpipeline/tiledb/move_mudata_obsp_to_tiledb",
