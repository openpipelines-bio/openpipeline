// move_mudata_obsm_to_tiledb qc-workflow-with-quantile-filtering_build
// 
...
meta = [
      ...
      "arguments" : [
        {
          "type" : "file",
          "name" : "--input_mudata",
          "description" : "MuData object to take the columns from. The observations and their order should\nmatch between the database and the input modality.\n",
          "must_exist" : true,
          "create_parent" : true,
          "required" : true,
          "direction" : "input",
        ...
        },
        {
          "type" : "string",
          "name" : "--obsm_input",
          "description" : "Keys from .obm to copy. The keys should not be present yet in the database.\n",
          "required" : false,
          "direction" : "input",
          "multiple" : true,
          "multiple_sep" : ";"
  ...
  "build_info" : {
    "config" : "/home/runner/work/openpipeline/openpipeline/src/tiledb/move_mudata_obsm_to_tiledb/config.vsh.yaml",
    "runner" : "nextflow",
    "engine" : "docker",
...
par = {
  ...
  'input_mudata': $( if [ ! -z ${VIASH_PAR_INPUT_MUDATA+x} ]; then echo "r'${VIASH_PAR_INPUT_MUDATA//\\'/\\'\\"\\'\\"r\\'}'"; else echo None; fi ),
  'modality': $( if [ ! -z ${VIASH_PAR_MODALITY+x} ]; then echo "r'${VIASH_PAR_MODALITY//\\'/\\'\\"\\'\\"r\\'}'"; else echo None; fi ),
  'obsm_input': $( if [ ! -z ${VIASH_PAR_OBSM_INPUT+x} ]; then echo "r'${VIASH_PAR_OBSM_INPUT//\\'/\\'\\"\\'\\"r\\'}'.split(';')"; else echo None; fi ),
  'output_tiledb': $( if [ ! -z ${VIASH_PAR_OUTPUT_TILEDB+x} ]; then echo "r'${VIASH_PAR_OUTPUT_TILEDB//\\'/\\'\\"\\'\\"r\\'}'"; else echo None; fi )
}
meta = {
