// move_mudata_obs_to_tiledb qc-workflow-with-quantile-filtering_build
// 
...
meta = [
    ...
    },
    {
      ...
      "arguments" : [
        ...
        },
        {
          "type" : "string",
          "name" : "--obs_input",
          "description" : "Columns from .obs to copy. The keys should not be present yet in the database.\n",
          "required" : false,
          "direction" : "input",
          "multiple" : true,
          "multiple_sep" : ";"
  ...
  "build_info" : {
    "config" : "/home/runner/work/openpipeline/openpipeline/src/tiledb/move_mudata_obs_to_tiledb/config.vsh.yaml",
    "runner" : "nextflow",
    "engine" : "docker",
...
par = {
  ...
  'input_dir': $( if [ ! -z ${VIASH_PAR_INPUT_DIR+x} ]; then echo "r'${VIASH_PAR_INPUT_DIR//\\'/\\'\\"\\'\\"r\\'}'"; else echo None; fi ),
  ...
  'obs_index_name_input': $( if [ ! -z ${VIASH_PAR_OBS_INDEX_NAME_INPUT+x} ]; then echo "r'${VIASH_PAR_OBS_INDEX_NAME_INPUT//\\'/\\'\\"\\'\\"r\\'}'"; else echo None; fi ),
  'input_mudata': $( if [ ! -z ${VIASH_PAR_INPUT_MUDATA+x} ]; then echo "r'${VIASH_PAR_INPUT_MUDATA//\\'/\\'\\"\\'\\"r\\'}'"; else echo None; fi ),
  'modality': $( if [ ! -z ${VIASH_PAR_MODALITY+x} ]; then echo "r'${VIASH_PAR_MODALITY//\\'/\\'\\"\\'\\"r\\'}'"; else echo None; fi ),
  'obs_input': $( if [ ! -z ${VIASH_PAR_OBS_INPUT+x} ]; then echo "r'${VIASH_PAR_OBS_INPUT//\\'/\\'\\"\\'\\"r\\'}'.split(';')"; else echo None; fi ),
...
meta["defaults"] = [
  ...
  "container" : {
    "registry" : "ghcr.io",
    "image" : "openpipelines-bio/openpipeline/tiledb/move_mudata_obs_to_tiledb",
