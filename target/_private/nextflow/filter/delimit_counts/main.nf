// delimit_counts qc-workflow-with-quantile-filtering_build
// 
...
meta = [
  ...
  "argument_groups" : [
    {
      ...
      "arguments" : [
        ...
        {
          "type" : "string",
          "name" : "--obs_count_column",
          "description" : "Name of column from .obs dataframe selecting\na column that contains integer or float values.\n",
          "example" : [
            "n_counts"
          ],
          "required" : true,
      ...
      "arguments" : [
        {
          "type" : "integer",
          "name" : "--min_count",
          "description" : "Min count for an observation to be retained (True in output).",
          "required" : false,
          "min" : 0,
          "direction" : "input",
          "multiple" : false,
        ...
        },
        {
          "type" : "integer",
          "name" : "--max_count",
          "description" : "Max count for an observation to be retained (True in output).",
          "required" : false,
          "min" : 0,
          "direction" : "input",
          "multiple" : false,
  ...
  "description" : "Turns an .obs column containing count values into a boolean column based on thresholds.\n",
  "test_resources" : [
    {
      "type" : "python_script",
      "path" : "test.py",
  ...
  "build_info" : {
    "config" : "/home/runner/work/openpipeline/openpipeline/src/filter/delimit_counts/config.vsh.yaml",
    "runner" : "nextflow",
    "engine" : "docker",
...
par = {
  ...
  'obs_count_column': $( if [ ! -z ${VIASH_PAR_OBS_COUNT_COLUMN+x} ]; then echo "r'${VIASH_PAR_OBS_COUNT_COLUMN//\\'/\\'\\"\\'\\"r\\'}'"; else echo None; fi ),
  ...
  'min_count': $( if [ ! -z ${VIASH_PAR_MIN_COUNT+x} ]; then echo "int(r'${VIASH_PAR_MIN_COUNT//\\'/\\'\\"\\'\\"r\\'}')"; else echo None; fi ),
  'max_count': $( if [ ! -z ${VIASH_PAR_MAX_COUNT+x} ]; then echo "int(r'${VIASH_PAR_MAX_COUNT//\\'/\\'\\"\\'\\"r\\'}')"; else echo None; fi ),
...
meta["defaults"] = [
  ...
  "container" : {
    "registry" : "ghcr.io",
    "image" : "openpipelines-bio/openpipeline/filter/delimit_counts",
