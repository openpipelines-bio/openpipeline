...
meta = [
  ...
  "build_info" : {
    "config" : "/workdir/root/repo/src/preprocessing/scale/config.vsh.yaml",
    "runner" : "nextflow",
    "engine" : "docker|native",
    "output" : "/workdir/root/repo/target/nextflow/preprocessing/scale",
    "viash_version" : "0.9.7",
...
meta["defaults"] = [
  ...
  "container" : {
    ...
    "image" : "vsh/openpipeline_rapids/preprocessing/scale",
    "tag" : "v0.1.3"
  },
  "label" : [
    "midmem",
