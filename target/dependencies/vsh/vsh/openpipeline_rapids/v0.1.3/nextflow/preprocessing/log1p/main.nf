...
meta = [
  ...
  "build_info" : {
    "config" : "/workdir/root/repo/src/preprocessing/log1p/config.vsh.yaml",
    "runner" : "nextflow",
    "engine" : "docker|native",
    "output" : "/workdir/root/repo/target/nextflow/preprocessing/log1p",
    "viash_version" : "0.9.7",
...
meta["defaults"] = [
  ...
  "container" : {
    ...
    "image" : "vsh/openpipeline_rapids/preprocessing/log1p",
    "tag" : "v0.1.3"
  },
  "label" : [
    "midmem",
