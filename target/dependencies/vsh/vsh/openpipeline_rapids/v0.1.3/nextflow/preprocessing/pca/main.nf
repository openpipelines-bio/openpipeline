...
meta = [
      ...
      "arguments" : [
        {
          "type" : "integer",
          "name" : "--num_components",
          "description" : "Number of principal components to compute. Defaults to 50, or\n1 - minimum dimension size of selected representation.\n",
          "example" : [
            25
          ],
          "required" : false,
        ...
        },
        {
          "type" : "integer",
          "name" : "--chunk_size",
          "description" : "Number of observations to include in each chunk. Required if\nchunked=True was passed.\n",
          "required" : false,
          "min" : 2,
          "direction" : "input",
          "multiple" : false,
  ...
  "build_info" : {
    "config" : "/workdir/root/repo/src/preprocessing/pca/config.vsh.yaml",
    "runner" : "nextflow",
    "engine" : "docker|native",
    "output" : "/workdir/root/repo/target/nextflow/preprocessing/pca",
    "viash_version" : "0.9.7",
...
meta["defaults"] = [
  ...
  "container" : {
    ...
    "image" : "vsh/openpipeline_rapids/preprocessing/pca",
    "tag" : "v0.1.3"
  },
  "label" : [
    "midmem",
