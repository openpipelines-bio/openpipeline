...
meta = [
  ...
  "argument_groups" : [
    {
      ...
      "arguments" : [
        ...
        },
        {
          "type" : "string",
          "name" : "--obsm_input",
          "description" : "Which .obsm slot to use as the PCA embedding to integrate (basis).",
          "default" : [
            "X_pca"
          ],
          "required" : false,
        ...
        },
        {
          "type" : "string",
          "name" : "--obs_covariates",
          "description" : "The .obs columns to integrate over (the batch/covariate keys passed to\nHarmony). Provide one or more comma-separated column names. When\nmultiple keys are provided, a combined batch variable is created from\nall columns.\n",
          "required" : true,
          "direction" : "input",
          "multiple" : true,
          "multiple_sep" : ","
      ...
      "arguments" : [
        {
          ...
          "description" : "Output h5mu file containing the integrated embedding.",
          "default" : [
            "output.h5mu"
          ],
          "must_exist" : true,
        ...
        },
        {
          "type" : "string",
          "name" : "--obsm_output",
          "description" : "In which .obsm slot to store the Harmony-corrected embedding.",
          "default" : [
            "X_pca_harmony"
          ],
          "required" : false,
        ...
        },
        {
          ...
          "description" : "Compression format to use for the output AnnData and/or Mudata\nobjects. By default no compression is applied.\n",
          "example" : [
            "gzip"
          ],
          "required" : false,
      ...
      "arguments" : [
        {
          "type" : "double",
          "name" : "--theta",
          "description" : "Diversity clustering penalty parameter. theta=0 does not encourage any\ndiversity; larger values result in more aggressive\ndiversity-encouraging correction over the covariates. Provide a single\nvalue for all covariates, or one value per --obs_covariates entry.\n",
          "default" : [
            2.0
          ],
          "required" : false,
        ...
        },
        {
          "type" : "string",
          "name" : "--flavor",
          "description" : "Which Harmony implementation to use. 'harmony2' is the faster\nreimplementation; 'harmony1' reproduces the original algorithm.\n",
          "default" : [
            "harmony2"
          ],
          "required" : false,
        ...
        },
        {
          "type" : "integer",
          "name" : "--n_clusters",
          "description" : "Number of clusters used by Harmony. If not set, the value is chosen\nautomatically.\n",
          "required" : false,
          "min" : 1,
          "direction" : "input",
          "multiple" : false,
        ...
        },
        {
          ...
          "description" : "Maximum number of rounds to run Harmony.",
          "default" : [
            10
          ],
          "required" : false,
  ...
  "description" : "Integrate observations over one or more batch/covariate columns on the GPU\nusing Harmony.\n\nWraps rapids-singlecell's `rsc.pp.harmony_integrate`, which runs Harmony batch\nintegration on a PCA embedding stored in `.obsm` and writes the corrected\nembedding to a new `.obsm` slot. Useful for removing batch effects prior to\ndownstream neighbor search, clustering, and embedding.\n",
  "test_resources" : [
    {
      "type" : "python_script",
      "path" : "test.py",
  ...
  "engines" : [
    {
      "type" : "docker",
      "id" : "docker",
      "image" : "nvidia/cuda:13.1.2-runtime-ubuntu24.04",
  ...
  "build_info" : {
    "config" : "/workdir/root/repo/src/preprocessing/harmony_integrate/config.vsh.yaml",
    "runner" : "nextflow",
    "engine" : "docker|native",
    "output" : "/workdir/root/repo/target/nextflow/preprocessing/harmony_integrate",
    "viash_version" : "0.9.7",
    "git_commit" : "d5eea3ab1e824144259ebf28b0239f71cf3a4688",
    "git_remote" : "https://github.com/openpipelines-bio/openpipeline_rapids"
  },
  "package_config" : {
    "name" : "openpipeline_rapids",
    "version" : "v0.1.3",
    "summary" : "Best-practice workflows for single-cell multi-omics analyses using rapids-singlecell.\n",
    "description" : "OpenPipelines are extensible single cell analysis pipelines for reproducible and large-scale single cell processing using [Viash](https://viash.io) and [Nextflow](https://www.nextflow.io/).\n\nThis repository contains GPU-enabled components using the [rapids-singlecell](https://rapids-singlecell.readthedocs.io/en/latest/) library.\n",
    "info" : {
      "test_resources" : [
        {
          "type" : "s3",
    ...
    "config_mods" : [
      ...
      ".engines[.type == 'docker'].target_tag := 'v0.1.3'"
    ],
    "keywords" : [
      "single-cell",
      "multimodal",
    ...
    "links" : {
      ...
      "issue_tracker" : "https://github.com/openpipelines-bio/openpipeline_rapids/issues"
    }
  }
}'''))
]
...
par = {
  ...
  'max_iter_harmony': $( if [ ! -z ${VIASH_PAR_MAX_ITER_HARMONY+x} ]; then echo "int(r'${VIASH_PAR_MAX_ITER_HARMONY//\\'/\\'\\"\\'\\"r\\'}')"; else echo None; fi ),
...
meta["defaults"] = [
  ...
  "container" : {
    ...
    "image" : "vsh/openpipeline_rapids/preprocessing/harmony_integrate",
    "tag" : "v0.1.3"
  },
  "label" : [
    "highcpu",
