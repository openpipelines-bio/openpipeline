...
meta = [
  ...
  "argument_groups" : [
    {
      ...
      "arguments" : [
        ...
        },
        {
          "type" : "string",
          "name" : "--input_layer",
          "description" : "Input layer to use. If not set, .X is used.",
          "required" : false,
          "direction" : "input",
          "multiple" : false,
          "multiple_sep" : ";"
    ...
    },
    {
      ...
      "arguments" : [
        ...
        },
        {
          "type" : "string",
          "name" : "--output_layer",
          "description" : "Output layer to write the transformed matrix to. If not set:\nwhen --input_layer is unset, .X is modified in-place; when\n--input_layer is set, that input layer is modified in-place.\n",
          "required" : false,
          "direction" : "input",
          "multiple" : false,
          "multiple_sep" : ";"
      ...
      "arguments" : [
        {
          "type" : "double",
          "name" : "--base",
          "description" : "Base of the logarithm. If unset, the natural logarithm is used.\n",
          "required" : false,
          "direction" : "input",
          "multiple" : false,
          "multiple_sep" : ";"
      ...
      "arguments" : [
        {
          "type" : "string",
          "name" : "--input_obsm",
          "description" : "Entry in .obsm to log-transform. Mutually exclusive with\n--input_layer.\n",
          "required" : false,
          "direction" : "input",
          "multiple" : false,
          "multiple_sep" : ";"
        },
        {
          "type" : "string",
          "name" : "--output_obsm",
          "description" : "Output entry in .obsm to write the transformed matrix to. Only valid\nwhen --input_obsm is set. If not set, the input .obsm entry is\nmodified in-place. Mutually exclusive with --output_layer.\n",
          "required" : false,
          "direction" : "input",
          "multiple" : false,
          "multiple_sep" : ";"
  ...
  "description" : "Logarithmize the data matrix, running either the GPU (rapids-singlecell) or\nthe CPU (scanpy) variant of log1p, selected with --device_type.\n\nComputes X = log(X + 1), where log denotes the natural logarithm unless\na different base is given.\n",
  "test_resources" : [
    {
      "type" : "nextflow_script",
      "path" : "test.nf",
  ...
  "build_info" : {
    "config" : "/workdir/root/repo/src/wrappers/preprocessing/log1p/config.vsh.yaml",
    "runner" : "nextflow",
    "engine" : "native",
    "output" : "/workdir/root/repo/target/_private/nextflow/wrappers/preprocessing/log1p",
    "viash_version" : "0.9.7",
...
include { log1p as log1p_gpu_viashalias } from "${meta.resources_dir}/../../../../../nextflow/preprocessing/log1p/main.nf"
log1p_gpu = log1p_gpu_viashalias.run(key: "log1p_gpu")
include { log1p as log1p_cpu_viashalias } from "${meta.root_dir}/dependencies/vsh/vsh/openpipeline/v4.1.0/nextflow/transform/log1p/main.nf"
log1p_cpu = log1p_cpu_viashalias.run(key: "log1p_cpu")
