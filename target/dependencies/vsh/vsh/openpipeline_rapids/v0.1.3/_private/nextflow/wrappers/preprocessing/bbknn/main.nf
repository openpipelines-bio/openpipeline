...
meta = [
  ...
  "argument_groups" : [
    {
      ...
      "arguments" : [
        ...
        },
        {
          "type" : "string",
          "name" : "--batch_key",
          "description" : "Which .obs column holds the batch assignment. Neighbors are searched\nwithin each batch separately and then merged.\n",
          "required" : true,
          "direction" : "input",
          "multiple" : false,
          "multiple_sep" : ";"
    ...
    {
      "name" : "Compute",
      "description" : "Options controlling which implementation of the component runs.",
      "arguments" : [
        {
          "type" : "string",
          "name" : "--device_type",
          "description" : "Which implementation to run: the GPU (rapids-singlecell) variant or the\nCPU (scanpy/squidpy) variant of the component. Selecting `gpu` requires a\nCUDA-capable GPU; the component errors out if none is available (there is\nno automatic fallback to CPU).",
          "default" : [
            "gpu"
          ],
          "required" : false,
      ...
      "arguments" : [
        {
          ...
          "description" : "How many top neighbors to report for each batch. Total number of\nneighbors per cell is this value times the number of batches.\n",
          "default" : [
            3
          ],
          "required" : false,
        ...
        },
        {
          "type" : "integer",
          "name" : "--n_pcs",
          "description" : "Number of dimensions of the `--obsm_input` representation to use.\nIf not set, all available dimensions are used.\n",
          "required" : false,
          "min" : 1,
          "direction" : "input",
          "multiple" : false,
    ...
    },
    {
      ...
      "arguments" : [
        ...
        },
        {
          "type" : "string",
          "name" : "--algorithm",
          "description" : "The KNN query algorithm to use (provided by cuVS).\nSee https://docs.rapids.ai/api/cuvs/stable/ for details.\n",
          "default" : [
            "brute"
          ],
          "required" : false,
  ...
  "build_info" : {
    "config" : "/workdir/root/repo/src/wrappers/preprocessing/bbknn/config.vsh.yaml",
    "runner" : "nextflow",
    "engine" : "native",
    "output" : "/workdir/root/repo/target/_private/nextflow/wrappers/preprocessing/bbknn",
    "viash_version" : "0.9.7",
...
include { bbknn as bbknn_gpu_viashalias } from "${meta.resources_dir}/../../../../../nextflow/preprocessing/bbknn/main.nf"
bbknn_gpu = bbknn_gpu_viashalias.run(key: "bbknn_gpu")
include { bbknn as bbknn_cpu_viashalias } from "${meta.root_dir}/dependencies/vsh/vsh/openpipeline/v4.1.0/nextflow/neighbors/bbknn/main.nf"
bbknn_cpu = bbknn_cpu_viashalias.run(key: "bbknn_cpu")
