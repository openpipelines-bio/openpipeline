...
meta = [
  ...
  "build_info" : {
    "config" : "/workdir/root/repo/src/wrappers/preprocessing/scale/config.vsh.yaml",
    "runner" : "nextflow",
    "engine" : "native",
    "output" : "/workdir/root/repo/target/_private/nextflow/wrappers/preprocessing/scale",
    "viash_version" : "0.9.7",
