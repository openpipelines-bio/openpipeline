...
meta = [
  ...
  "build_info" : {
    "config" : "/workdir/root/repo/src/wrappers/preprocessing/neighbors/config.vsh.yaml",
    "runner" : "nextflow",
    "engine" : "native",
    "output" : "/workdir/root/repo/target/_private/nextflow/wrappers/preprocessing/neighbors",
    "viash_version" : "0.9.7",
