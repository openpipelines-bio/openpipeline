...
meta = [
  ...
  "argument_groups" : [
    {
      ...
      "arguments" : [
        ...
        },
        {
          "type" : "string",
          "name" : "--input_layer",
          "description" : "Input layer to use for expression values. By default, X is used.\n",
          "required" : false,
          "direction" : "input",
          "multiple" : false,
          "multiple_sep" : ";"
    ...
    },
    {
      ...
      "arguments" : [
        ...
        },
        {
          ...
          "description" : "In which .var slot to store a boolean array indicating which features\nare highly variable.\n",
          "default" : [
            "highly_variable"
          ],
          "required" : false,
        ...
        },
        {
          "type" : "string",
          "name" : "--varm_name",
          "description" : "In which .varm slot to store the per-gene HVG metrics.\n",
          "default" : [
            "hvg"
          ],
          "required" : false,
      ...
      "arguments" : [
        {
          "type" : "string",
          "name" : "--flavor",
          "description" : "Choose the flavor for identifying highly variable genes. For the\ndispersion-based methods in their default workflows, Seurat passes\nthe cutoffs whereas Cell Ranger passes n_top_features. The\n'seurat_v3_paper', 'pearson_residuals' and 'poisson_gene_selection'\nflavors are only available on the GPU (rapids-singlecell) variant.\n",
          "default" : [
            "seurat"
          ],
          "required" : false,
        ...
        },
        {
          "type" : "integer",
          "name" : "--n_top_features",
          "description" : "Number of highly-variable features to keep. Mandatory if flavor is\n'seurat_v3', 'seurat_v3_paper', 'pearson_residuals' or\n'poisson_gene_selection'.\n",
          "required" : false,
          "direction" : "input",
          "multiple" : false,
          "multiple_sep" : ";"
      ...
      "arguments" : [
        {
          "type" : "integer",
          "name" : "--theta",
          "description" : "The negative binomial overdispersion parameter for Pearson residuals.\nHigher values correspond to less overdispersion. Only used if flavor\nis 'pearson_residuals'.\n",
          "default" : [
            100
          ],
          "required" : false,
        ...
        },
        {
          "type" : "double",
          "name" : "--clip",
          "description" : "Determines if and how Pearson residuals are clipped. If unset,\nresiduals are clipped to [-sqrt(n_obs), sqrt(n_obs)]. If a scalar c is\ngiven, residuals are clipped to [-c, c]. Only used if flavor is\n'pearson_residuals'.\n",
          "required" : false,
          "direction" : "input",
          "multiple" : false,
          "multiple_sep" : ";"
        },
        {
          "type" : "integer",
          "name" : "--chunksize",
          "description" : "If flavor is 'poisson_gene_selection', this determines how many genes\nare processed at once. Choosing a smaller value will reduce the\nrequired memory.\n",
          "default" : [
            1000
          ],
          "required" : false,
        ...
        },
        {
          "type" : "integer",
          "name" : "--n_samples",
          "description" : "The number of Binomial samples used to estimate the posterior\nprobability of enrichment of zeros for each gene. Only used if flavor\nis 'poisson_gene_selection'.\n",
          "default" : [
            10000
          ],
          "required" : false,
    ...
    {
      "name" : "Scanpy options",
      "description" : "Exposed only by the CPU (scanpy) variant (--device_type cpu).",
      "arguments" : [
        {
          "type" : "string",
          "name" : "--var_input",
  ...
  "dependencies" : [
    {
      "name" : "preprocessing/highly_variable_genes",
      "alias" : "highly_variable_genes_gpu",
      "repository" : {
        "type" : "local"
      }
    },
    {
      ...
      "alias" : "highly_variable_genes_cpu",
      "repository" : {
        "type" : "vsh",
        "repo" : "openpipeline",
        "tag" : "v4.1.0"
  ...
  "build_info" : {
    "config" : "/workdir/root/repo/src/wrappers/preprocessing/highly_variable_genes/config.vsh.yaml",
    "runner" : "nextflow",
    "engine" : "native",
    "output" : "/workdir/root/repo/target/_private/nextflow/wrappers/preprocessing/highly_variable_genes",
    "viash_version" : "0.9.7",
...
include { highly_variable_genes as highly_variable_genes_gpu_viashalias } from "${meta.resources_dir}/../../../../../nextflow/preprocessing/highly_variable_genes/main.nf"
highly_variable_genes_gpu = highly_variable_genes_gpu_viashalias.run(key: "highly_variable_genes_gpu")
include { highly_variable_features_scanpy as highly_variable_genes_cpu_viashalias } from "${meta.root_dir}/dependencies/vsh/vsh/openpipeline/v4.1.0/nextflow/feature_annotation/highly_variable_features_scanpy/main.nf"
highly_variable_genes_cpu = highly_variable_genes_cpu_viashalias.run(key: "highly_variable_genes_cpu")
