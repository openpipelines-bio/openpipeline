...
meta = [
  ...
  "description" : "Integrate observations over one or more batch/covariate columns using Harmony,\nrunning either the GPU (rapids-singlecell) or the CPU (harmonypy) variant of\nharmony_integrate, selected with --device_type.\n",
  "test_resources" : [
    {
      "type" : "nextflow_script",
      "path" : "test.nf",
  ...
  "dependencies" : [
    {
      "name" : "preprocessing/harmony_integrate",
      "alias" : "harmony_integrate_gpu",
      "repository" : {
        "type" : "local"
      }
    },
  ...
  "build_info" : {
    "config" : "/workdir/root/repo/src/wrappers/preprocessing/harmony_integrate/config.vsh.yaml",
    "runner" : "nextflow",
    "engine" : "native",
    "output" : "/workdir/root/repo/target/_private/nextflow/wrappers/preprocessing/harmony_integrate",
    "viash_version" : "0.9.7",
...
include { harmony_integrate as harmony_integrate_gpu_viashalias } from "${meta.resources_dir}/../../../../../nextflow/preprocessing/harmony_integrate/main.nf"
harmony_integrate_gpu = harmony_integrate_gpu_viashalias.run(key: "harmony_integrate_gpu")
include { harmonypy as harmony_integrate_cpu_viashalias } from "${meta.root_dir}/dependencies/vsh/vsh/openpipeline/v4.1.0/nextflow/integrate/harmonypy/main.nf"
harmony_integrate_cpu = harmony_integrate_cpu_viashalias.run(key: "harmony_integrate_cpu")
