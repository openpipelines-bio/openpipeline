...
meta = [
  ...
  "build_info" : {
    "config" : "/workdir/root/repo/src/wrappers/preprocessing/normalize_total/config.vsh.yaml",
    "runner" : "nextflow",
    "engine" : "native",
    "output" : "/workdir/root/repo/target/_private/nextflow/wrappers/preprocessing/normalize_total",
    "viash_version" : "0.9.7",
