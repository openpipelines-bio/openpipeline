...
thisConfig = processConfig(jsonSlurper.parseText('''{
    ...
    "resources" : [
      {
        ...
        "path" : "script.py",
        "is_executable" : true,
        "parent" : "file:/home/runner/work/openpipeline/openpipeline/src/convert/from_velocyto_to_h5mu/config.vsh.yaml"
      }
    ],
  ...
  "info" : {
    "config" : "/home/runner/work/openpipeline/openpipeline/src/convert/from_velocyto_to_h5mu/config.vsh.yaml",
    "platform" : "nextflow",
    "viash_version" : "0.6.4",
...
thisDefaultProcessArgs = [
  ...
  "container" : {
    "registry" : "ghcr.io",
    "image" : "openpipelines-bio/convert_from_velocyto_to_h5mu",
    "tag" : "dev"
  },
  "tag" : "$id"
}'''),
