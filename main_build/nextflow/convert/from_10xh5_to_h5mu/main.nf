// from_10xh5_to_h5mu dev
// 
// This wrapper script is auto-generated by viash 0.6.4 and is thus a derivative
...
thisConfig = processConfig(jsonSlurper.parseText('''{
    ...
    "resources" : [
      {
        ...
        "path" : "script.py",
        "is_executable" : true,
        "parent" : "file:/home/runner/work/openpipeline/openpipeline/src/convert/from_10xh5_to_h5mu/config.vsh.yaml"
      }
    ],
  ...
  "info" : {
    ...
    "platform" : "nextflow",
    "viash_version" : "0.6.4",
    "git_commit" : "63981752172f803fcceb3b78549113d2a1716254",
