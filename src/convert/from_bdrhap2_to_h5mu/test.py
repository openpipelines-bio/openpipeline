...
assert "sample_id" in rna_adata.obs.keys(), "RNA modality should contain column 'sample_id'."
...
assert "sample_id" in prot_adata.obs.keys(), "Protein modality should contain column 'sample_id'."
...
assert "CD279:EH12-1|PDCD1|AHS0014|pAbO" in data.var_names, 'Output should contain abc column "CD279:EH12-1|PDCD1|AHS0014|pAbO".'
