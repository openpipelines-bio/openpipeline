...
def test_sample_split(run_component, random_path, input_h5mu, input_h5mu_path):
    ...
    assert s1.n_obs == input_h5mu.n_obs, "number of modalities of split file does not match input file"
    assert s2.n_obs == input_h5mu.n_obs, "number of modalities of split file does not match input file"
