...
include { bd_rhapsody2 } from params.rootDir + "/target/nextflow/workflows/ingestion/bd_rhapsody2/main.nf"
include { bd_rhapsody2_test } from params.rootDir + "/target/nextflow/test_workflows/ingestion/bd_rhapsody2_test/main.nf"
  ...
  output_ch = Channel.fromList(
    [
      [
        ...
        reference_archive: resources_test.resolve("reference_gencodev41_chr1/reference_bd_rhapsody_v2.tar.gz"),
