...
input_mu = mu.read_h5mu(par["orig_input"], "pbmc_1k_protein_v3.h5mu")
...
for i, row in enumerate(data):
    ...
    if row[0] == "rna":
        assert_annotation_objects_equal(rna_mod, mod_mu.mod["rna"])
    elif row[0] == "prot":
        assert_annotation_objects_equal(prot_mod, mod_mu.mod["prot"])
