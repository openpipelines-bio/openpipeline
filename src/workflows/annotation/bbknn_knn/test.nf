...
include { bbknn_knn } from params.rootDir + "/target/nextflow/workflows/annotation/bbknn_knn/main.nf"
include { bbknn_knn_test } from params.rootDir + "/target/nextflow/test_workflows/annotation/bbknn_knn_test/main.nf"
