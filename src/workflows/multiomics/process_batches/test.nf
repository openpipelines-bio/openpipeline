...
include { workflow_test } from targetDir + "/_test/nextflow/workflows/multiomics/process_batches/workflow_test/main.nf"
include { workflow_test2 } from targetDir + "/_test/nextflow/workflows/multiomics/process_batches/workflow_test2/main.nf"
