workflow run_wf {
  ...
  def singlesample_arguments = [
      ...
      "rna_percentile_filter_log_transform_total_counts": "rna_percentile_filter_log_transform_total_counts",
      ...
      "prot_percentile_filter_log_transform_total_counts": "prot_percentile_filter_log_transform_total_counts",
