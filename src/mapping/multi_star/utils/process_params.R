...
manual_args <- c(
  ...
  "readFilesIn", "genomeTransformOutput", "genomeFileSizes", "genomeChrSetMitochondrial",
...
yaml::write_yaml(list(argument_groups = argument_groups), "src/mapping/star_and_htseq/arguments_star.yaml")
