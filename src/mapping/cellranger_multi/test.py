...
raw_dir = meta["resources_dir"] + "/raw/"
reference_dir = meta["resources_dir"] + "/reference_gencodev41_chr1/"

## VIASH START
raw_dir = meta["resources_dir"] + "/10x_5k_anticmv/raw/"
reference_dir = meta["resources_dir"] + "/reference_gencodev41_chr1/"
## VIASH END

input1_R1 = raw_dir + "/5k_human_antiCMV_T_TBNK_connect_GEX_1_subset_S1_L001_R1_001.fastq.gz"
input1_R2 = raw_dir + "/5k_human_antiCMV_T_TBNK_connect_GEX_1_subset_S1_L001_R2_001.fastq.gz"
input2_R1 = raw_dir + "/5k_human_antiCMV_T_TBNK_connect_AB_subset_S2_L004_R1_001.fastq.gz"
input2_R2 = raw_dir + "/5k_human_antiCMV_T_TBNK_connect_AB_subset_S2_L004_R2_001.fastq.gz"
input3_R1 =  raw_dir + "/5k_human_antiCMV_T_TBNK_connect_VDJ_subset_S1_L001_R1_001.fastq.gz"
input3_R2 =  raw_dir + "/5k_human_antiCMV_T_TBNK_connect_VDJ_subset_S1_L001_R2_001.fastq.gz"
gex_reference =  reference_dir + "/reference_cellranger.tar.gz"
feature_reference = raw_dir + "/feature_reference.csv"
vdj_reference = raw_dir + "/refdata-cellranger-vdj-GRCh38-alts-ensembl-7.0.0.tar.gz"
