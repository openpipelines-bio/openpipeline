...
input1_R1 = (
    resources_dir
    / "10x_5k_anticmv/raw/5k_human_antiCMV_T_TBNK_connect_GEX_1_subset_S1_L001_R1_001.fastq.gz"
)
input1_R2 = (
    resources_dir
    / "10x_5k_anticmv/raw/5k_human_antiCMV_T_TBNK_connect_GEX_1_subset_S1_L001_R2_001.fastq.gz"
)
input2_R1 = (
    resources_dir
    / "10x_5k_anticmv/raw/5k_human_antiCMV_T_TBNK_connect_AB_subset_S2_L004_R1_001.fastq.gz"
)
input2_R2 = (
    resources_dir
    / "10x_5k_anticmv/raw/5k_human_antiCMV_T_TBNK_connect_AB_subset_S2_L004_R2_001.fastq.gz"
)
input3_R1 = (
    resources_dir
    / "10x_5k_anticmv/raw/5k_human_antiCMV_T_TBNK_connect_VDJ_subset_S1_L001_R1_001.fastq.gz"
)
input3_R2 = (
    resources_dir
    / "10x_5k_anticmv/raw/5k_human_antiCMV_T_TBNK_connect_VDJ_subset_S1_L001_R2_001.fastq.gz"
)
...
vdj_reference = (
    resources_dir
    / "10x_5k_anticmv/raw/refdata-cellranger-vdj-GRCh38-alts-ensembl-7.0.0.tar.gz"
)

# Beam Input
input1_R1_beam = (
    resources_dir
    / "10x_5k_beam/raw/beamt_human_A0201_B0702_pbmc_gex_subset_S3_L001_R1_001.fastq.gz"
)
input1_R2_beam = (
    resources_dir
    / "10x_5k_beam/raw/beamt_human_A0201_B0702_pbmc_gex_subset_S3_L001_R2_001.fastq.gz"
)
input2_R1_beam = (
    resources_dir
    / "10x_5k_beam/raw/beamt_human_A0201_B0702_pbmc_ag_subset_S1_L001_R1_001.fastq.gz"
)
input2_R2_beam = (
    resources_dir
    / "10x_5k_beam/raw/beamt_human_A0201_B0702_pbmc_ag_subset_S1_L001_R2_001.fastq.gz"
)
input3_R1_beam = (
    resources_dir
    / "10x_5k_beam/raw/beamt_human_A0201_B0702_pbmc_vdj_subset_S2_L001_R1_001.fastq.gz"
)
input3_R2_beam = (
    resources_dir
    / "10x_5k_beam/raw/beamt_human_A0201_B0702_pbmc_vdj_subset_S2_L001_R2_001.fastq.gz"
)
vdj_reference_beam = (
    resources_dir
    / "10x_5k_beam/raw/5k_BEAM-T_Human_A0201_B0702_PBMC_5pv2_Multiplex_vdj_reference.tar.gz"
)
feature_reference_beam = (
    resources_dir / "10x_5k_beam/raw/beamt_human_A0201_B0702_pbmc_feature_reference.csv"
)
...
def test_cellranger_multi_directory_input(run_component, random_path):
    args = [
        ...
        random_path(),
        "--input",
        meta["resources_dir"] + "/10x_5k_anticmv/raw/",
        "--gex_reference",
        gex_reference,
        "--vdj_reference",
        vdj_reference,
...
def test_vdj_inner_enrichment_primers(run_component, random_path):
    ...
    args = [
        ...
        str(make_path_relative(enrichment_primers_file)),
        "--dryrun",
    ]
    run_component(args)
...
def test_cellranger_multi_crispr_data(run_component, random_path):
    ...
    args = [
        "--input",
        meta["resources_dir"]
        + "/10x_5k_lung_crispr/raw/SC3_v3_NextGem_DI_CRISPR_A549_5K_gex_subset_S5_L001_R1_001.fastq.gz",
        "--input",
        meta["resources_dir"]
        + "/10x_5k_lung_crispr/raw/SC3_v3_NextGem_DI_CRISPR_A549_5K_gex_subset_S5_L001_R2_001.fastq.gz",
        "--input",
        meta["resources_dir"]
        + "/10x_5k_lung_crispr/raw/SC3_v3_NextGem_DI_CRISPR_A549_5K_crispr_subset_S4_L001_R1_001.fastq.gz",
        "--input",
        meta["resources_dir"]
        + "/10x_5k_lung_crispr/raw/SC3_v3_NextGem_DI_CRISPR_A549_5K_crispr_subset_S4_L001_R2_001.fastq.gz",
        "--library_id",
        ...
        "--feature_reference",
        meta["resources_dir"]
        + "/10x_5k_lung_crispr/raw/SC3_v3_NextGem_DI_CRISPR_A549_5K_Multiplex_count_feature_reference_corrected.csv",
        "--output",
        outputpath,
    ]
    run_component(args)
...
def test_cellranger_multi_beam_data(run_component, random_path):
    ...
    args = [
        ...
        input3_R2_beam,
        "--library_id",
        "beamt_human_A0201_B0702_pbmc_gex_subset;beamt_human_A0201_B0702_pbmc_ag_subset;beamt_human_A0201_B0702_pbmc_vdj_subset",
        "--library_type",
        "Gene Expression;VDJ-T;Antigen Capture",
        "--gex_reference",
        gex_reference,
        "--vdj_reference",
        vdj_reference_beam,
        ...
        outputpath,
        "--control_id",
        "negative_control_A0201;negative_control_B0702",
        "--mhc_allele",
...
def test_cellranger_multi_fixed_rna(run_component, random_path):
    ...
    args = [
        "--input",
        f"{meta['resources_dir']}/10x_5k_fixed/raw/",
        "--library_id",
        "4plex_human_liver_colorectal_ovarian_panc_scFFPE_multiplex_subset",
        "--library_type",
        "Gene Expression",
        "--feature_reference",
        f"{meta['resources_dir']}/10x_5k_fixed/raw/4plex_mouse_LymphNode_Spleen_TotalSeqC_multiplex_feature_reference.csv",
        "--gex_reference",
        gex_reference,
        "--output",
        outputpath,
        ...
        "--sample_ids",
        "Liver_BC1;Ovarian_BC2;Colorectal_BC3;Pancreas_BC4",
        "--gex_generate_bam",
        "false",
        "--library_lanes",
        "any",
        "--probe_set",
        f"{meta['resources_dir']}/10x_5k_fixed/raw/Chromium_Human_Transcriptome_Probe_Set_v1.0_GRCh38-2020-A_corrected.csv",
        "--sample_force_cells",
        "5000;-1;-1;-1",
    ]
    run_component(args)
...
def test_cellranger_multi_with_alternative_names(run_component, random_path):
    ...
    # remove lanes
    input1_R1_link = (
        input_dir / "5k_human_antiCMV_T_TBNK_connect_GEX_1_subset_S1_R1_001.fastq.gz"
    )
    input1_R2_link = (
        input_dir / "5k_human_antiCMV_T_TBNK_connect_GEX_1_subset_S1_R2_001.fastq.gz"
    )
    input2_R1_link = (
        input_dir / "5k_human_antiCMV_T_TBNK_connect_AB_subset_S2_R1_001.fastq.gz"
    )
    input2_R2_link = (
        input_dir / "5k_human_antiCMV_T_TBNK_connect_AB_subset_S2_R2_001.fastq.gz"
    )
    input3_R1_link = (
        input_dir / "5k_human_antiCMV_T_TBNK_connect_VDJ_subset_S1_R1_001.fastq"
    )
    input3_R2_link = (
        input_dir / "5k_human_antiCMV_T_TBNK_connect_VDJ_subset_S1_R2_001.fastq"
    )
