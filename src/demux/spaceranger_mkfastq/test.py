...
## VIASH START
meta = {
    "functionality_name": "spaceranger_mkfastq",
...
input = meta["resources_dir"] + "/spaceranger_tiny_bcl/bcl"
sample_sheet = meta["resources_dir"] + "/spaceranger_tiny_bcl/bcl/sample_sheet.csv"
output = "test_output"
