...
* This project now uses viash version 0.8.1 to build components and workflows. Moving to 0.8.1 involved the following changes:

    * Bump viash version to 0.8.1 (PR #598 and PR #606) in the project configuration.
