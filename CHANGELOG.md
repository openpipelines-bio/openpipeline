...
* `utils/set_var_index`: ensure the index dtype is string instead of category to prevent errors when the index is subsequently updated (e.g. when making var index names unique) (PR #1114).
