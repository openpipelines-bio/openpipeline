...
meta = [
      ...
      },
      {
        ...
        "arguments" : [
          ...
          },
          {
            ...
            "description" : "Optional. The rate at which reads from the provided FASTQ files are sampled.\nMust be strictly greater than 0 and less than or equal to 1.\n",
            "example" : [
              "0.5"
            ],
            "required" : false,
  ...
  "info" : {
    "config" : "/home/runner/work/openpipeline/openpipeline/src/workflows/ingestion/cellranger_multi/config.vsh.yaml",
    "platform" : "nextflow",
...
def innerWorkflowFactory(args) {
  return cellranger_multi_entrypoint
}
